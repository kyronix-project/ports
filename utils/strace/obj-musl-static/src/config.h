...
/* Define to 1 if 'si_trapno' is a member of 'siginfo_t'. */
...
/* Define to 1 if 'btf_vmlinux_id' is a member of 'struct bpf_map_info'. */
...
/* Define to 1 if 'hash' is a member of 'struct bpf_map_info'. */
#define HAVE_STRUCT_BPF_MAP_INFO_HASH 1

/* Define to 1 if 'hash_size' is a member of 'struct bpf_map_info'. */
...
/* Define to 1 if 'attach_btf_id' is a member of 'struct bpf_prog_info'. */
#define HAVE_STRUCT_BPF_PROG_INFO_ATTACH_BTF_ID 1

/* Define to 1 if 'attach_btf_obj_id' is a member of 'struct bpf_prog_info'.
   */
...
/* Define to 1 if 'flags' is a member of 'struct kvm_run'. */
#define HAVE_STRUCT_KVM_RUN_FLAGS 1

/* Define to 1 if 'immediate_exit' is a member of 'struct kvm_run'. */
...
/* Define to 1 if the system has the type 'struct sockaddr_ipx'. */
...
/* Define to 1 if 'btf_flags' is a member of 'union bpf_attr'. */
...
/* Define to 1 if 'btf_log_true_size' is a member of 'union bpf_attr'. */
...
/* Define to 1 if 'btf_token_fd' is a member of 'union bpf_attr'. */
...
/* Define to 1 if 'core_relos' is a member of 'union bpf_attr'. */
#define HAVE_UNION_BPF_ATTR_CORE_RELOS 1

/* Define to 1 if 'core_relo_cnt' is a member of 'union bpf_attr'. */
#define HAVE_UNION_BPF_ATTR_CORE_RELO_CNT 1

/* Define to 1 if 'core_relo_rec_size' is a member of 'union bpf_attr'. */
...
/* Define to 1 if 'enable_stats.type' is a member of 'union bpf_attr'. */
#define HAVE_UNION_BPF_ATTR_ENABLE_STATS_TYPE 1

/* Define to 1 if 'excl_prog_hash' is a member of 'union bpf_attr'. */
#define HAVE_UNION_BPF_ATTR_EXCL_PROG_HASH 1

/* Define to 1 if 'excl_prog_hash_size' is a member of 'union bpf_attr'. */
...
/* Define to 1 if 'expected_revision' is a member of 'union bpf_attr'. */
...
/* Define to 1 if 'fd_array_cnt' is a member of 'union bpf_attr'. */
#define HAVE_UNION_BPF_ATTR_FD_ARRAY_CNT 1

/* Define to 1 if 'fd_by_id_token_fd' is a member of 'union bpf_attr'. */
...
/* Define to 1 if 'iter_create.flags' is a member of 'union bpf_attr'. */
#define HAVE_UNION_BPF_ATTR_ITER_CREATE_FLAGS 1

/* Define to 1 if 'iter_create.link_fd' is a member of 'union bpf_attr'. */
...
/* Define to 1 if 'keyring_id' is a member of 'union bpf_attr'. */
...
/* Define to 1 if 'link_create.expected_revision' is a member of 'union
   bpf_attr'. */
...
/* Define to 1 if 'link_create.hooknum' is a member of 'union bpf_attr'. */
...
/* Define to 1 if 'link_create.netfilter' is a member of 'union bpf_attr'. */
#define HAVE_UNION_BPF_ATTR_LINK_CREATE_NETFILTER 1

/* Define to 1 if 'link_create.offsets' is a member of 'union bpf_attr'. */
/* #undef HAVE_UNION_BPF_ATTR_LINK_CREATE_OFFSETS */

/* Define to 1 if 'link_create.path' is a member of 'union bpf_attr'. */
...
/* Define to 1 if 'link_create.pf' is a member of 'union bpf_attr'. */
/* #undef HAVE_UNION_BPF_ATTR_LINK_CREATE_PF */

/* Define to 1 if 'link_create.pid' is a member of 'union bpf_attr'. */
/* #undef HAVE_UNION_BPF_ATTR_LINK_CREATE_PID */

/* Define to 1 if 'link_create.priority' is a member of 'union bpf_attr'. */
...
/* Define to 1 if 'link_create.ref_ctr_offsets' is a member of 'union
   bpf_attr'. */
/* #undef HAVE_UNION_BPF_ATTR_LINK_CREATE_REF_CTR_OFFSETS */

/* Define to 1 if 'link_create.relative_fd' is a member of 'union bpf_attr'.
   */
/* #undef HAVE_UNION_BPF_ATTR_LINK_CREATE_RELATIVE_FD */

/* Define to 1 if 'link_create.relative_id' is a member of 'union bpf_attr'.
   */
...
/* Define to 1 if 'link_create.target_ifindex' is a member of 'union
   bpf_attr'. */
#define HAVE_UNION_BPF_ATTR_LINK_CREATE_TARGET_IFINDEX 1

/* Define to 1 if 'link_create.uprobe_multi' is a member of 'union bpf_attr'.
   */
#define HAVE_UNION_BPF_ATTR_LINK_CREATE_UPROBE_MULTI 1

/* Define to 1 if 'link_detach.link_fd' is a member of 'union bpf_attr'. */
...
/* Define to 1 if 'log_true_size' is a member of 'union bpf_attr'. */
...
/* Define to 1 if 'map_token_fd' is a member of 'union bpf_attr'. */
...
/* Define to 1 if 'path_fd' is a member of 'union bpf_attr'. */
#define HAVE_UNION_BPF_ATTR_PATH_FD 1

/* Define to 1 if 'prog_assoc_struct_ops' is a member of 'union bpf_attr'. */
#define HAVE_UNION_BPF_ATTR_PROG_ASSOC_STRUCT_OPS 1

/* Define to 1 if 'prog_bind_map.flags' is a member of 'union bpf_attr'. */
#define HAVE_UNION_BPF_ATTR_PROG_BIND_MAP_FLAGS 1

/* Define to 1 if 'prog_bind_map.map_fd' is a member of 'union bpf_attr'. */
#define HAVE_UNION_BPF_ATTR_PROG_BIND_MAP_MAP_FD 1

/* Define to 1 if 'prog_bind_map.prog_fd' is a member of 'union bpf_attr'. */
...
/* Define to 1 if 'prog_stream_read.prog_fd' is a member of 'union bpf_attr'.
   */
#define HAVE_UNION_BPF_ATTR_PROG_STREAM_READ_PROG_FD 1

/* Define to 1 if 'prog_stream_read.stream_buf' is a member of 'union
   bpf_attr'. */
#define HAVE_UNION_BPF_ATTR_PROG_STREAM_READ_STREAM_BUF 1

/* Define to 1 if 'prog_stream_read.stream_buf_len' is a member of 'union
   bpf_attr'. */
#define HAVE_UNION_BPF_ATTR_PROG_STREAM_READ_STREAM_BUF_LEN 1

/* Define to 1 if 'prog_stream_read.stream_id' is a member of 'union
   bpf_attr'. */
#define HAVE_UNION_BPF_ATTR_PROG_STREAM_READ_STREAM_ID 1

/* Define to 1 if 'prog_token_fd' is a member of 'union bpf_attr'. */
...
/* Define to 1 if 'query.dummy' is a member of 'union bpf_attr'. */
/* #undef HAVE_UNION_BPF_ATTR_QUERY_DUMMY */

/* Define to 1 if 'query.link_attach_flags' is a member of 'union bpf_attr'.
   */
#define HAVE_UNION_BPF_ATTR_QUERY_LINK_ATTACH_FLAGS 1

/* Define to 1 if 'query.link_ids' is a member of 'union bpf_attr'. */
#define HAVE_UNION_BPF_ATTR_QUERY_LINK_IDS 1

/* Define to 1 if 'query.prog_attach_flags' is a member of 'union bpf_attr'.
   */
...
/* Define to 1 if 'query.revision' is a member of 'union bpf_attr'. */
...
/* Define to 1 if 'query.target_ifindex' is a member of 'union bpf_attr'. */
#define HAVE_UNION_BPF_ATTR_QUERY_TARGET_IFINDEX 1

/* Define to 1 if 'raw_tracepoint.cookie' is a member of 'union bpf_attr'. */
#define HAVE_UNION_BPF_ATTR_RAW_TRACEPOINT_COOKIE 1

/* Define to 1 if 'raw_tracepoint.dummy' is a member of 'union bpf_attr'. */
...
/* Define to 1 if 'relative_fd' is a member of 'union bpf_attr'. */
#define HAVE_UNION_BPF_ATTR_RELATIVE_FD 1

/* Define to 1 if 'relative_id' is a member of 'union bpf_attr'. */
...
/* Define to 1 if 'signature' is a member of 'union bpf_attr'. */
#define HAVE_UNION_BPF_ATTR_SIGNATURE 1

/* Define to 1 if 'signature_size' is a member of 'union bpf_attr'. */
...
/* Define to 1 if 'target_ifindex' is a member of 'union bpf_attr'. */
...
/* Define to 1 if 'token_create.bpffs_fd' is a member of 'union bpf_attr'. */
#define HAVE_UNION_BPF_ATTR_TOKEN_CREATE_BPFFS_FD 1

/* Define to 1 if 'token_create.flags' is a member of 'union bpf_attr'. */
...
/* Define to 1 if 'value_type_btf_obj_fd' is a member of 'union bpf_attr'. */
...
#define PACKAGE_STRING "strace 7.1"
...
/* Date */
#define STRACE_MANPAGE_DATE "2026-05-19"
