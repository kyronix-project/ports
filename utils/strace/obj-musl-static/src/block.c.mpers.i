...
const struct xlat blkpg_ops[1] = { {
 ...
 .size = (sizeof(blkpg_ops_xdata) / sizeof((blkpg_ops_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__((blkpg_ops_xdata)), __typeof__(&(blkpg_ops_xdata)[0])))]) * 0)),
 .type = XT_INDEXED,
 .flags_mask = 0
  | ((unsigned) (1))
  | ((unsigned) (2))
...
print_blkpg_req(struct tcb *tcp, const struct_blkpg_ioctl_arg *blkpg)
{
 ...
 tprint_struct_next();
 do { tprints_field_name("flags"); tprintf_string("%lld", (sizeof((*blkpg).flags) == sizeof(char) ? (long long) (signed char) ((*blkpg).flags) : sizeof((*blkpg).flags) == sizeof(short) ? (long long) (short) ((*blkpg).flags) : sizeof((*blkpg).flags) == sizeof(int) ? (long long) (int) ((*blkpg).flags) : sizeof((*blkpg).flags) == sizeof(long) ? (long long) (long) ((*blkpg).flags) : (long long) ((*blkpg).flags))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("datalen"); tprintf_string("%lld", (sizeof((*blkpg).datalen) == sizeof(char) ? (long long) (signed char) ((*blkpg).datalen) : sizeof((*blkpg).datalen) == sizeof(short) ? (long long) (short) ((*blkpg).datalen) : sizeof((*blkpg).datalen) == sizeof(int) ? (long long) (int) ((*blkpg).datalen) : sizeof((*blkpg).datalen) == sizeof(long) ? (long long) (long) ((*blkpg).datalen) : (long long) ((*blkpg).datalen))); } while (0);
 tprint_struct_next();
 tprints_field_name("data");
 if (!umoven_or_printaddr((tcp), (((kernel_ulong_t) (unsigned long) (blkpg->data))), sizeof(*(&p)), (void *) (&p))) {
  tprint_struct_begin();
  do { tprints_field_name("start"); tprintf_string("%lld", (sizeof((p).start) == sizeof(char) ? (long long) (signed char) ((p).start) : sizeof((p).start) == sizeof(short) ? (long long) (short) ((p).start) : sizeof((p).start) == sizeof(int) ? (long long) (int) ((p).start) : sizeof((p).start) == sizeof(long) ? (long long) (long) ((p).start) : (long long) ((p).start))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("length"); tprintf_string("%lld", (sizeof((p).length) == sizeof(char) ? (long long) (signed char) ((p).length) : sizeof((p).length) == sizeof(short) ? (long long) (short) ((p).length) : sizeof((p).length) == sizeof(int) ? (long long) (int) ((p).length) : sizeof((p).length) == sizeof(long) ? (long long) (long) ((p).length) : (long long) ((p).length))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("pno"); tprintf_string("%lld", (sizeof((p).pno) == sizeof(char) ? (long long) (signed char) ((p).pno) : sizeof((p).pno) == sizeof(short) ? (long long) (short) ((p).pno) : sizeof((p).pno) == sizeof(int) ? (long long) (int) ((p).pno) : sizeof((p).pno) == sizeof(long) ? (long long) (long) ((p).pno) : (long long) ((p).pno))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("devname"); print_quoted_cstring((const char *) (p).devname, sizeof((p).devname) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__(((p).devname)), __typeof__(&((p).devname)[0])))]) * 0)); } while (0);
  tprint_struct_next();
  do { tprints_field_name("volname"); print_quoted_cstring((const char *) (p).volname, sizeof((p).volname) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__(((p).volname)), __typeof__(&((p).volname)[0])))]) * 0)); } while (0);
  tprint_struct_end();
 }
 tprint_struct_end();
}
MPERS_PRINTER_DECL(int, block_ioctl, struct tcb *const tcp, const unsigned int code, const kernel_ulong_t arg)
{
 ...
 case (((2U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((128)) << 0) | ((((sizeof(__u64)))) << ((0 +8)+8))):
  if ((!((tcp)->flags & 0x04)))
   return 0;
  tprints_arg_next_name("argp");
 ...
 case (((2U|1U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((115)) << 0) | ((((sizeof(struct blk_user_trace_setup)))) << ((0 +8)+8))):
  if ((!((tcp)->flags & 0x04))) {
   ...
   if (umoven_or_printaddr((tcp), (arg), sizeof(*(&buts)), (void *) (&buts)))
    break;
   tprint_struct_begin();
   do { tprints_field_name("act_mask"); tprintf_string("%llu", (sizeof((buts).act_mask) == sizeof(char) ? (unsigned long long) (unsigned char) ((buts).act_mask) : sizeof((buts).act_mask) == sizeof(short) ? (unsigned long long) (unsigned short) ((buts).act_mask) : sizeof((buts).act_mask) == sizeof(int) ? (unsigned long long) (unsigned int) ((buts).act_mask) : sizeof((buts).act_mask) == sizeof(long) ? (unsigned long long) (unsigned long) ((buts).act_mask) : (unsigned long long) ((buts).act_mask))); } while (0);
   tprint_struct_next();
   do { tprints_field_name("buf_size"); tprintf_string("%llu", (sizeof((buts).buf_size) == sizeof(char) ? (unsigned long long) (unsigned char) ((buts).buf_size) : sizeof((buts).buf_size) == sizeof(short) ? (unsigned long long) (unsigned short) ((buts).buf_size) : sizeof((buts).buf_size) == sizeof(int) ? (unsigned long long) (unsigned int) ((buts).buf_size) : sizeof((buts).buf_size) == sizeof(long) ? (unsigned long long) (unsigned long) ((buts).buf_size) : (unsigned long long) ((buts).buf_size))); } while (0);
   tprint_struct_next();
   do { tprints_field_name("buf_nr"); tprintf_string("%llu", (sizeof((buts).buf_nr) == sizeof(char) ? (unsigned long long) (unsigned char) ((buts).buf_nr) : sizeof((buts).buf_nr) == sizeof(short) ? (unsigned long long) (unsigned short) ((buts).buf_nr) : sizeof((buts).buf_nr) == sizeof(int) ? (unsigned long long) (unsigned int) ((buts).buf_nr) : sizeof((buts).buf_nr) == sizeof(long) ? (unsigned long long) (unsigned long) ((buts).buf_nr) : (unsigned long long) ((buts).buf_nr))); } while (0);
   tprint_struct_next();
   do { tprints_field_name("start_lba"); tprintf_string("%llu", (sizeof((buts).start_lba) == sizeof(char) ? (unsigned long long) (unsigned char) ((buts).start_lba) : sizeof((buts).start_lba) == sizeof(short) ? (unsigned long long) (unsigned short) ((buts).start_lba) : sizeof((buts).start_lba) == sizeof(int) ? (unsigned long long) (unsigned int) ((buts).start_lba) : sizeof((buts).start_lba) == sizeof(long) ? (unsigned long long) (unsigned long) ((buts).start_lba) : (unsigned long long) ((buts).start_lba))); } while (0);
   tprint_struct_next();
   do { tprints_field_name("end_lba"); tprintf_string("%llu", (sizeof((buts).end_lba) == sizeof(char) ? (unsigned long long) (unsigned char) ((buts).end_lba) : sizeof((buts).end_lba) == sizeof(short) ? (unsigned long long) (unsigned short) ((buts).end_lba) : sizeof((buts).end_lba) == sizeof(int) ? (unsigned long long) (unsigned int) ((buts).end_lba) : sizeof((buts).end_lba) == sizeof(long) ? (unsigned long long) (unsigned long) ((buts).end_lba) : (unsigned long long) ((buts).end_lba))); } while (0);
   tprint_struct_next();
   ...
   if (!((tcp)->u_error != 0) && !umoven((tcp), (arg), sizeof(*(&buts)), (void *) (&buts))) {
    tprint_struct_next();
    do { tprints_field_name("name"); print_quoted_cstring((const char *) (buts).name, sizeof((buts).name) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__(((buts).name)), __typeof__(&((buts).name)[0])))]) * 0)); } while (0);
   }
   tprint_struct_end();
   break;
  }
