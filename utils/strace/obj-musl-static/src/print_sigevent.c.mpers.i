...
;
_Static_assert((0) == (0), "SIGEV_SIGNAL != 0");
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
;
_Static_assert((1) == (1), "SIGEV_NONE != 1");
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
;
_Static_assert((2) == (2), "SIGEV_THREAD != 2");
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
;
_Static_assert((4) == (4), "SIGEV_THREAD_ID != 4");

#pragma GCC diagnostic pop
;

static const struct xlat_data sigev_value_xdata[] = {
 [0] = { (unsigned)(0), "SIGEV_SIGNAL" },
 [1] = { (unsigned)(1), "SIGEV_NONE" },
 [2] = { (unsigned)(2), "SIGEV_THREAD" },
 [4] = { (unsigned)(4), "SIGEV_THREAD_ID" },
};
static
const struct xlat sigev_value[1] = { {
 .data = sigev_value_xdata,
 .size = (sizeof(sigev_value_xdata) / sizeof((sigev_value_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__((sigev_value_xdata)), __typeof__(&(sigev_value_xdata)[0])))]) * 0)),
 .type = XT_INDEXED,
 .flags_mask = 0
  | ((unsigned) (0))
  | ((unsigned) (1))
...
{
 tprint_struct_begin();
 do { tprints_field_name("sival_int"); tprintf_string("%lld", (sizeof((v).sival_int) == sizeof(char) ? (long long) (signed char) ((v).sival_int) : sizeof((v).sival_int) == sizeof(short) ? (long long) (short) ((v).sival_int) : sizeof((v).sival_int) == sizeof(int) ? (long long) (int) ((v).sival_int) : sizeof((v).sival_int) == sizeof(long) ? (long long) (long) ((v).sival_int) : (long long) ((v).sival_int))); } while (0);
 tprint_struct_next();
...
MPERS_PRINTER_DECL(void, print_sigevent, struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 case 4:
  ...
  break;
 default:
  do { tprints_field_name("sigev_signo"); tprintf_string("%llu", (sizeof((sev).sigev_signo) == sizeof(char) ? (unsigned long long) (unsigned char) ((sev).sigev_signo) : sizeof((sev).sigev_signo) == sizeof(short) ? (unsigned long long) (unsigned short) ((sev).sigev_signo) : sizeof((sev).sigev_signo) == sizeof(int) ? (unsigned long long) (unsigned int) ((sev).sigev_signo) : sizeof((sev).sigev_signo) == sizeof(long) ? (unsigned long long) (unsigned long) ((sev).sigev_signo) : (unsigned long long) ((sev).sigev_signo))); } while (0);
 }
 tprint_struct_next();
 ...
 case 4:
  tprint_struct_next();
  do { tprints_field_name("sigev_notify_thread_id"); tprintf_string("%lld", (sizeof((sev).sigev_un.tid) == sizeof(char) ? (long long) (signed char) ((sev).sigev_un.tid) : sizeof((sev).sigev_un.tid) == sizeof(short) ? (long long) (short) ((sev).sigev_un.tid) : sizeof((sev).sigev_un.tid) == sizeof(int) ? (long long) (int) ((sev).sigev_un.tid) : sizeof((sev).sigev_un.tid) == sizeof(long) ? (long long) (long) ((sev).sigev_un.tid) : (long long) ((sev).sigev_un.tid))); } while (0);
  break;
 case 2:
  tprint_struct_next();
