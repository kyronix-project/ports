...
MPERS_PRINTER_DECL(int, decode_sg_req_info, struct tcb *const tcp, const kernel_ulong_t arg)
{
 ...
 if (!umoven_or_printaddr((tcp), (arg), sizeof(*(&info)), (void *) (&info))) {
  tprint_struct_begin();
  do { tprints_field_name("req_state"); tprintf_string("%lld", (sizeof((info).req_state) == sizeof(char) ? (long long) (signed char) ((info).req_state) : sizeof((info).req_state) == sizeof(short) ? (long long) (short) ((info).req_state) : sizeof((info).req_state) == sizeof(int) ? (long long) (int) ((info).req_state) : sizeof((info).req_state) == sizeof(long) ? (long long) (long) ((info).req_state) : (long long) ((info).req_state))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("orphan"); tprintf_string("%lld", (sizeof((info).orphan) == sizeof(char) ? (long long) (signed char) ((info).orphan) : sizeof((info).orphan) == sizeof(short) ? (long long) (short) ((info).orphan) : sizeof((info).orphan) == sizeof(int) ? (long long) (int) ((info).orphan) : sizeof((info).orphan) == sizeof(long) ? (long long) (long) ((info).orphan) : (long long) ((info).orphan))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("sg_io_owned"); tprintf_string("%lld", (sizeof((info).sg_io_owned) == sizeof(char) ? (long long) (signed char) ((info).sg_io_owned) : sizeof((info).sg_io_owned) == sizeof(short) ? (long long) (short) ((info).sg_io_owned) : sizeof((info).sg_io_owned) == sizeof(int) ? (long long) (int) ((info).sg_io_owned) : sizeof((info).sg_io_owned) == sizeof(long) ? (long long) (long) ((info).sg_io_owned) : (long long) ((info).sg_io_owned))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("problem"); tprintf_string("%lld", (sizeof((info).problem) == sizeof(char) ? (long long) (signed char) ((info).problem) : sizeof((info).problem) == sizeof(short) ? (long long) (short) ((info).problem) : sizeof((info).problem) == sizeof(int) ? (long long) (int) ((info).problem) : sizeof((info).problem) == sizeof(long) ? (long long) (long) ((info).problem) : (long long) ((info).problem))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("pack_id"); tprintf_string("%lld", (sizeof((info).pack_id) == sizeof(char) ? (long long) (signed char) ((info).pack_id) : sizeof((info).pack_id) == sizeof(short) ? (long long) (short) ((info).pack_id) : sizeof((info).pack_id) == sizeof(int) ? (long long) (int) ((info).pack_id) : sizeof((info).pack_id) == sizeof(long) ? (long long) (long) ((info).pack_id) : (long long) ((info).pack_id))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("usr_ptr"); printaddr((mpers_ptr_t) (info).usr_ptr); } while (0);
  tprint_struct_next();
  do { tprints_field_name("duration"); tprintf_string("%llu", (sizeof((info).duration) == sizeof(char) ? (unsigned long long) (unsigned char) ((info).duration) : sizeof((info).duration) == sizeof(short) ? (unsigned long long) (unsigned short) ((info).duration) : sizeof((info).duration) == sizeof(int) ? (unsigned long long) (unsigned int) ((info).duration) : sizeof((info).duration) == sizeof(long) ? (unsigned long long) (unsigned long) ((info).duration) : (unsigned long long) ((info).duration))); } while (0);
  tprint_struct_end();
 }
 return 0200;
}
