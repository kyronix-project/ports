...
const struct xlat loop_flags_options[1] = { {
 ...
 .size = (sizeof(loop_flags_options_xdata) / sizeof((loop_flags_options_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__((loop_flags_options_xdata)), __typeof__(&(loop_flags_options_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
...
const struct xlat loop_crypt_type_options[1] = { {
 ...
 .size = (sizeof(loop_crypt_type_options_xdata) / sizeof((loop_crypt_type_options_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__((loop_crypt_type_options_xdata)), __typeof__(&(loop_crypt_type_options_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((unsigned) (0))
  | ((unsigned) (1))
...
decode_loop_info(struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&info)), (void *) (&info)))
  return;
 tprint_struct_begin();
 do { tprints_field_name("lo_number"); tprintf_string("%lld", (sizeof((info).lo_number) == sizeof(char) ? (long long) (signed char) ((info).lo_number) : sizeof((info).lo_number) == sizeof(short) ? (long long) (short) ((info).lo_number) : sizeof((info).lo_number) == sizeof(int) ? (long long) (int) ((info).lo_number) : sizeof((info).lo_number) == sizeof(long) ? (long long) (long) ((info).lo_number) : (long long) ((info).lo_number))); } while (0);
 if (!((tcp)->qual_flg & 0x002)) {
  tprint_struct_next();
  do { tprints_field_name("lo_device"); print_dev_t((info).lo_device); } while (0);
  tprint_struct_next();
  do { tprints_field_name("lo_inode"); tprintf_string("%llu", (sizeof((info).lo_inode) == sizeof(char) ? (unsigned long long) (unsigned char) ((info).lo_inode) : sizeof((info).lo_inode) == sizeof(short) ? (unsigned long long) (unsigned short) ((info).lo_inode) : sizeof((info).lo_inode) == sizeof(int) ? (unsigned long long) (unsigned int) ((info).lo_inode) : sizeof((info).lo_inode) == sizeof(long) ? (unsigned long long) (unsigned long) ((info).lo_inode) : (unsigned long long) ((info).lo_inode))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("lo_rdevice"); print_dev_t((info).lo_rdevice); } while (0);
 }
 tprint_struct_next();
 do { tprints_field_name("lo_offset"); tprintf_string("%#llx", (sizeof((info).lo_offset) == sizeof(char) ? (unsigned long long) (unsigned char) ((info).lo_offset) : sizeof((info).lo_offset) == sizeof(short) ? (unsigned long long) (unsigned short) ((info).lo_offset) : sizeof((info).lo_offset) == sizeof(int) ? (unsigned long long) (unsigned int) ((info).lo_offset) : sizeof((info).lo_offset) == sizeof(long) ? (unsigned long long) (unsigned long) ((info).lo_offset) : (unsigned long long) ((info).lo_offset))); } while (0);
 if (!((tcp)->qual_flg & 0x002) || info.lo_encrypt_type != 0) {
  ...
  tprint_struct_next();
  do { tprints_field_name("lo_encrypt_key_size"); tprintf_string("%llu", (sizeof((info).lo_encrypt_key_size) == sizeof(char) ? (unsigned long long) (unsigned char) ((info).lo_encrypt_key_size) : sizeof((info).lo_encrypt_key_size) == sizeof(short) ? (unsigned long long) (unsigned short) ((info).lo_encrypt_key_size) : sizeof((info).lo_encrypt_key_size) == sizeof(int) ? (unsigned long long) (unsigned int) ((info).lo_encrypt_key_size) : sizeof((info).lo_encrypt_key_size) == sizeof(long) ? (unsigned long long) (unsigned long) ((info).lo_encrypt_key_size) : (unsigned long long) ((info).lo_encrypt_key_size))); } while (0);
 }
 tprint_struct_next();
 ...
 tprint_struct_next();
 do { tprints_field_name("lo_name"); print_quoted_cstring((const char *) (info).lo_name, sizeof((info).lo_name) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__(((info).lo_name)), __typeof__(&((info).lo_name)[0])))]) * 0)); } while (0);
 if (!((tcp)->qual_flg & 0x002) || info.lo_encrypt_type != 0) {
 ...
 if (!((tcp)->qual_flg & 0x002)) {
  tprint_struct_next();
  do { tprints_field_name("lo_init"); for (size_t i_ = 0; i_ < (sizeof(((info)).lo_init) / sizeof((((info)).lo_init)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__((((info)).lo_init)), __typeof__(&(((info)).lo_init)[0])))]) * 0)); ++i_) { if (i_) tprint_array_next(); else tprint_array_begin(); tprintf_string("%#llx", (sizeof(((info)).lo_init[i_]) == sizeof(char) ? (unsigned long long) (unsigned char) (((info)).lo_init[i_]) : sizeof(((info)).lo_init[i_]) == sizeof(short) ? (unsigned long long) (unsigned short) (((info)).lo_init[i_]) : sizeof(((info)).lo_init[i_]) == sizeof(int) ? (unsigned long long) (unsigned int) (((info)).lo_init[i_]) : sizeof(((info)).lo_init[i_]) == sizeof(long) ? (unsigned long long) (unsigned long) (((info)).lo_init[i_]) : (unsigned long long) (((info)).lo_init[i_]))); } tprint_array_end(); } while (0);
  tprint_struct_next();
  do { tprints_field_name("reserved"); for (size_t i_ = 0; i_ < (sizeof(((info)).reserved) / sizeof((((info)).reserved)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__((((info)).reserved)), __typeof__(&(((info)).reserved)[0])))]) * 0)); ++i_) { if (i_) tprint_array_next(); else tprint_array_begin(); tprintf_string("%#llx", (sizeof(((info)).reserved[i_]) == sizeof(char) ? (unsigned long long) (unsigned char) (((info)).reserved[i_]) : sizeof(((info)).reserved[i_]) == sizeof(short) ? (unsigned long long) (unsigned short) (((info)).reserved[i_]) : sizeof(((info)).reserved[i_]) == sizeof(int) ? (unsigned long long) (unsigned int) (((info)).reserved[i_]) : sizeof(((info)).reserved[i_]) == sizeof(long) ? (unsigned long long) (unsigned long) (((info)).reserved[i_]) : (unsigned long long) (((info)).reserved[i_]))); } tprint_array_end(); } while (0);
 } else {
  tprint_struct_next();
...
print_loop_info64(struct tcb *const tcp, const struct loop_info64 *const info64)
{
 if (!((tcp)->qual_flg & 0x002)) {
  ...
  tprint_struct_next();
  do { tprints_field_name("lo_inode"); tprintf_string("%llu", (sizeof((*info64).lo_inode) == sizeof(char) ? (unsigned long long) (unsigned char) ((*info64).lo_inode) : sizeof((*info64).lo_inode) == sizeof(short) ? (unsigned long long) (unsigned short) ((*info64).lo_inode) : sizeof((*info64).lo_inode) == sizeof(int) ? (unsigned long long) (unsigned int) ((*info64).lo_inode) : sizeof((*info64).lo_inode) == sizeof(long) ? (unsigned long long) (unsigned long) ((*info64).lo_inode) : (unsigned long long) ((*info64).lo_inode))); } while (0);
  tprint_struct_next();
  ...
  tprint_struct_next();
  do { tprints_field_name("lo_sizelimit"); tprintf_string("%llu", (sizeof((*info64).lo_sizelimit) == sizeof(char) ? (unsigned long long) (unsigned char) ((*info64).lo_sizelimit) : sizeof((*info64).lo_sizelimit) == sizeof(short) ? (unsigned long long) (unsigned short) ((*info64).lo_sizelimit) : sizeof((*info64).lo_sizelimit) == sizeof(int) ? (unsigned long long) (unsigned int) ((*info64).lo_sizelimit) : sizeof((*info64).lo_sizelimit) == sizeof(long) ? (unsigned long long) (unsigned long) ((*info64).lo_sizelimit) : (unsigned long long) ((*info64).lo_sizelimit))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("lo_number"); tprintf_string("%llu", (sizeof((*info64).lo_number) == sizeof(char) ? (unsigned long long) (unsigned char) ((*info64).lo_number) : sizeof((*info64).lo_number) == sizeof(short) ? (unsigned long long) (unsigned short) ((*info64).lo_number) : sizeof((*info64).lo_number) == sizeof(int) ? (unsigned long long) (unsigned int) ((*info64).lo_number) : sizeof((*info64).lo_number) == sizeof(long) ? (unsigned long long) (unsigned long) ((*info64).lo_number) : (unsigned long long) ((*info64).lo_number))); } while (0);
 } else {
  tprint_struct_begin();
  do { tprints_field_name("lo_offset"); tprintf_string("%#llx", (sizeof((*info64).lo_offset) == sizeof(char) ? (unsigned long long) (unsigned char) ((*info64).lo_offset) : sizeof((*info64).lo_offset) == sizeof(short) ? (unsigned long long) (unsigned short) ((*info64).lo_offset) : sizeof((*info64).lo_offset) == sizeof(int) ? (unsigned long long) (unsigned int) ((*info64).lo_offset) : sizeof((*info64).lo_offset) == sizeof(long) ? (unsigned long long) (unsigned long) ((*info64).lo_offset) : (unsigned long long) ((*info64).lo_offset))); } while (0);
  tprint_struct_next();
 ...
 if (!((tcp)->qual_flg & 0x002) || info64->lo_encrypt_type != 0) {
  ...
  tprint_struct_next();
  do { tprints_field_name("lo_encrypt_key_size"); tprintf_string("%llu", (sizeof((*info64).lo_encrypt_key_size) == sizeof(char) ? (unsigned long long) (unsigned char) ((*info64).lo_encrypt_key_size) : sizeof((*info64).lo_encrypt_key_size) == sizeof(short) ? (unsigned long long) (unsigned short) ((*info64).lo_encrypt_key_size) : sizeof((*info64).lo_encrypt_key_size) == sizeof(int) ? (unsigned long long) (unsigned int) ((*info64).lo_encrypt_key_size) : sizeof((*info64).lo_encrypt_key_size) == sizeof(long) ? (unsigned long long) (unsigned long) ((*info64).lo_encrypt_key_size) : (unsigned long long) ((*info64).lo_encrypt_key_size))); } while (0);
 }
 tprint_struct_next();
 ...
 tprint_struct_next();
 do { tprints_field_name("lo_file_name"); print_quoted_cstring((const char *) (*info64).lo_file_name, sizeof((*info64).lo_file_name) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__(((*info64).lo_file_name)), __typeof__(&((*info64).lo_file_name)[0])))]) * 0)); } while (0);
 if (!((tcp)->qual_flg & 0x002) || info64->lo_encrypt_type != 0) {
  tprint_struct_next();
  do { tprints_field_name("lo_crypt_name"); print_quoted_cstring((const char *) (*info64).lo_crypt_name, sizeof((*info64).lo_crypt_name) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__(((*info64).lo_crypt_name)), __typeof__(&((*info64).lo_crypt_name)[0])))]) * 0)); } while (0);
  const unsigned int lo_encrypt_key_size =
 ...
 if (!((tcp)->qual_flg & 0x002)) {
  tprint_struct_next();
  do { tprints_field_name("lo_init"); for (size_t i_ = 0; i_ < (sizeof(((*info64)).lo_init) / sizeof((((*info64)).lo_init)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__((((*info64)).lo_init)), __typeof__(&(((*info64)).lo_init)[0])))]) * 0)); ++i_) { if (i_) tprint_array_next(); else tprint_array_begin(); tprintf_string("%#llx", (sizeof(((*info64)).lo_init[i_]) == sizeof(char) ? (unsigned long long) (unsigned char) (((*info64)).lo_init[i_]) : sizeof(((*info64)).lo_init[i_]) == sizeof(short) ? (unsigned long long) (unsigned short) (((*info64)).lo_init[i_]) : sizeof(((*info64)).lo_init[i_]) == sizeof(int) ? (unsigned long long) (unsigned int) (((*info64)).lo_init[i_]) : sizeof(((*info64)).lo_init[i_]) == sizeof(long) ? (unsigned long long) (unsigned long) (((*info64)).lo_init[i_]) : (unsigned long long) (((*info64)).lo_init[i_]))); } tprint_array_end(); } while (0);
 } else {
  tprint_struct_next();
  tprint_more_data_follows();
 }
...
decode_loop_config(struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 tprint_struct_next();
 do { tprints_field_name("block_size"); tprintf_string("%llu", (sizeof((config).block_size) == sizeof(char) ? (unsigned long long) (unsigned char) ((config).block_size) : sizeof((config).block_size) == sizeof(short) ? (unsigned long long) (unsigned short) ((config).block_size) : sizeof((config).block_size) == sizeof(int) ? (unsigned long long) (unsigned int) ((config).block_size) : sizeof((config).block_size) == sizeof(long) ? (unsigned long long) (unsigned long) ((config).block_size) : (unsigned long long) ((config).block_size))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("info"); (print_loop_info64)((tcp), &((config).info)); } while (0);
 if (!is_filled((const char *) (config.__reserved), 0, sizeof(config.__reserved) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__((config.__reserved)), __typeof__(&(config.__reserved)[0])))]) * 0))) {
  tprint_struct_next();
  do { tprints_field_name("__reserved"); for (size_t i_ = 0; i_ < (sizeof(((config)).__reserved) / sizeof((((config)).__reserved)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__((((config)).__reserved)), __typeof__(&(((config)).__reserved)[0])))]) * 0)); ++i_) { if (i_) tprint_array_next(); else tprint_array_begin(); tprintf_string("%#llx", (sizeof(((config)).__reserved[i_]) == sizeof(char) ? (unsigned long long) (unsigned char) (((config)).__reserved[i_]) : sizeof(((config)).__reserved[i_]) == sizeof(short) ? (unsigned long long) (unsigned short) (((config)).__reserved[i_]) : sizeof(((config)).__reserved[i_]) == sizeof(int) ? (unsigned long long) (unsigned int) (((config)).__reserved[i_]) : sizeof(((config)).__reserved[i_]) == sizeof(long) ? (unsigned long long) (unsigned long) (((config)).__reserved[i_]) : (unsigned long long) (((config)).__reserved[i_]))); } tprint_array_end(); } while (0);
 }
 tprint_struct_end();
}
MPERS_PRINTER_DECL(int, loop_ioctl, struct tcb *tcp, const unsigned int code, const kernel_ulong_t arg)
{
 ...
 case 0x4C81:
  tprints_arg_next_name("argp");
  tprintf_string("%lld", (sizeof((int) arg) == sizeof(char) ? (long long) (signed char) ((int) arg) : sizeof((int) arg) == sizeof(short) ? (long long) (short) ((int) arg) : sizeof((int) arg) == sizeof(int) ? (long long) (int) ((int) arg) : sizeof((int) arg) == sizeof(long) ? (long long) (long) ((int) arg) : (long long) ((int) arg)));
  break;
 case 0x4C08:
 case 0x4C09:
  tprints_arg_next_name("argp");
