...
MPERS_PRINTER_DECL(void, printrusage, struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 if (((tcp)->qual_flg & 0x002)) {
  ...
  tprint_struct_next();
  do { tprints_field_name("ru_maxrss"); tprintf_string("%llu", (sizeof((ru).ru_maxrss) == sizeof(char) ? (unsigned long long) (unsigned char) ((ru).ru_maxrss) : sizeof((ru).ru_maxrss) == sizeof(short) ? (unsigned long long) (unsigned short) ((ru).ru_maxrss) : sizeof((ru).ru_maxrss) == sizeof(int) ? (unsigned long long) (unsigned int) ((ru).ru_maxrss) : sizeof((ru).ru_maxrss) == sizeof(long) ? (unsigned long long) (unsigned long) ((ru).ru_maxrss) : (unsigned long long) ((ru).ru_maxrss))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("ru_ixrss"); tprintf_string("%llu", (sizeof((ru).ru_ixrss) == sizeof(char) ? (unsigned long long) (unsigned char) ((ru).ru_ixrss) : sizeof((ru).ru_ixrss) == sizeof(short) ? (unsigned long long) (unsigned short) ((ru).ru_ixrss) : sizeof((ru).ru_ixrss) == sizeof(int) ? (unsigned long long) (unsigned int) ((ru).ru_ixrss) : sizeof((ru).ru_ixrss) == sizeof(long) ? (unsigned long long) (unsigned long) ((ru).ru_ixrss) : (unsigned long long) ((ru).ru_ixrss))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("ru_idrss"); tprintf_string("%llu", (sizeof((ru).ru_idrss) == sizeof(char) ? (unsigned long long) (unsigned char) ((ru).ru_idrss) : sizeof((ru).ru_idrss) == sizeof(short) ? (unsigned long long) (unsigned short) ((ru).ru_idrss) : sizeof((ru).ru_idrss) == sizeof(int) ? (unsigned long long) (unsigned int) ((ru).ru_idrss) : sizeof((ru).ru_idrss) == sizeof(long) ? (unsigned long long) (unsigned long) ((ru).ru_idrss) : (unsigned long long) ((ru).ru_idrss))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("ru_isrss"); tprintf_string("%llu", (sizeof((ru).ru_isrss) == sizeof(char) ? (unsigned long long) (unsigned char) ((ru).ru_isrss) : sizeof((ru).ru_isrss) == sizeof(short) ? (unsigned long long) (unsigned short) ((ru).ru_isrss) : sizeof((ru).ru_isrss) == sizeof(int) ? (unsigned long long) (unsigned int) ((ru).ru_isrss) : sizeof((ru).ru_isrss) == sizeof(long) ? (unsigned long long) (unsigned long) ((ru).ru_isrss) : (unsigned long long) ((ru).ru_isrss))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("ru_minflt"); tprintf_string("%llu", (sizeof((ru).ru_minflt) == sizeof(char) ? (unsigned long long) (unsigned char) ((ru).ru_minflt) : sizeof((ru).ru_minflt) == sizeof(short) ? (unsigned long long) (unsigned short) ((ru).ru_minflt) : sizeof((ru).ru_minflt) == sizeof(int) ? (unsigned long long) (unsigned int) ((ru).ru_minflt) : sizeof((ru).ru_minflt) == sizeof(long) ? (unsigned long long) (unsigned long) ((ru).ru_minflt) : (unsigned long long) ((ru).ru_minflt))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("ru_majflt"); tprintf_string("%llu", (sizeof((ru).ru_majflt) == sizeof(char) ? (unsigned long long) (unsigned char) ((ru).ru_majflt) : sizeof((ru).ru_majflt) == sizeof(short) ? (unsigned long long) (unsigned short) ((ru).ru_majflt) : sizeof((ru).ru_majflt) == sizeof(int) ? (unsigned long long) (unsigned int) ((ru).ru_majflt) : sizeof((ru).ru_majflt) == sizeof(long) ? (unsigned long long) (unsigned long) ((ru).ru_majflt) : (unsigned long long) ((ru).ru_majflt))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("ru_nswap"); tprintf_string("%llu", (sizeof((ru).ru_nswap) == sizeof(char) ? (unsigned long long) (unsigned char) ((ru).ru_nswap) : sizeof((ru).ru_nswap) == sizeof(short) ? (unsigned long long) (unsigned short) ((ru).ru_nswap) : sizeof((ru).ru_nswap) == sizeof(int) ? (unsigned long long) (unsigned int) ((ru).ru_nswap) : sizeof((ru).ru_nswap) == sizeof(long) ? (unsigned long long) (unsigned long) ((ru).ru_nswap) : (unsigned long long) ((ru).ru_nswap))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("ru_inblock"); tprintf_string("%llu", (sizeof((ru).ru_inblock) == sizeof(char) ? (unsigned long long) (unsigned char) ((ru).ru_inblock) : sizeof((ru).ru_inblock) == sizeof(short) ? (unsigned long long) (unsigned short) ((ru).ru_inblock) : sizeof((ru).ru_inblock) == sizeof(int) ? (unsigned long long) (unsigned int) ((ru).ru_inblock) : sizeof((ru).ru_inblock) == sizeof(long) ? (unsigned long long) (unsigned long) ((ru).ru_inblock) : (unsigned long long) ((ru).ru_inblock))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("ru_oublock"); tprintf_string("%llu", (sizeof((ru).ru_oublock) == sizeof(char) ? (unsigned long long) (unsigned char) ((ru).ru_oublock) : sizeof((ru).ru_oublock) == sizeof(short) ? (unsigned long long) (unsigned short) ((ru).ru_oublock) : sizeof((ru).ru_oublock) == sizeof(int) ? (unsigned long long) (unsigned int) ((ru).ru_oublock) : sizeof((ru).ru_oublock) == sizeof(long) ? (unsigned long long) (unsigned long) ((ru).ru_oublock) : (unsigned long long) ((ru).ru_oublock))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("ru_msgsnd"); tprintf_string("%llu", (sizeof((ru).ru_msgsnd) == sizeof(char) ? (unsigned long long) (unsigned char) ((ru).ru_msgsnd) : sizeof((ru).ru_msgsnd) == sizeof(short) ? (unsigned long long) (unsigned short) ((ru).ru_msgsnd) : sizeof((ru).ru_msgsnd) == sizeof(int) ? (unsigned long long) (unsigned int) ((ru).ru_msgsnd) : sizeof((ru).ru_msgsnd) == sizeof(long) ? (unsigned long long) (unsigned long) ((ru).ru_msgsnd) : (unsigned long long) ((ru).ru_msgsnd))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("ru_msgrcv"); tprintf_string("%llu", (sizeof((ru).ru_msgrcv) == sizeof(char) ? (unsigned long long) (unsigned char) ((ru).ru_msgrcv) : sizeof((ru).ru_msgrcv) == sizeof(short) ? (unsigned long long) (unsigned short) ((ru).ru_msgrcv) : sizeof((ru).ru_msgrcv) == sizeof(int) ? (unsigned long long) (unsigned int) ((ru).ru_msgrcv) : sizeof((ru).ru_msgrcv) == sizeof(long) ? (unsigned long long) (unsigned long) ((ru).ru_msgrcv) : (unsigned long long) ((ru).ru_msgrcv))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("ru_nsignals"); tprintf_string("%llu", (sizeof((ru).ru_nsignals) == sizeof(char) ? (unsigned long long) (unsigned char) ((ru).ru_nsignals) : sizeof((ru).ru_nsignals) == sizeof(short) ? (unsigned long long) (unsigned short) ((ru).ru_nsignals) : sizeof((ru).ru_nsignals) == sizeof(int) ? (unsigned long long) (unsigned int) ((ru).ru_nsignals) : sizeof((ru).ru_nsignals) == sizeof(long) ? (unsigned long long) (unsigned long) ((ru).ru_nsignals) : (unsigned long long) ((ru).ru_nsignals))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("ru_nvcsw"); tprintf_string("%llu", (sizeof((ru).ru_nvcsw) == sizeof(char) ? (unsigned long long) (unsigned char) ((ru).ru_nvcsw) : sizeof((ru).ru_nvcsw) == sizeof(short) ? (unsigned long long) (unsigned short) ((ru).ru_nvcsw) : sizeof((ru).ru_nvcsw) == sizeof(int) ? (unsigned long long) (unsigned int) ((ru).ru_nvcsw) : sizeof((ru).ru_nvcsw) == sizeof(long) ? (unsigned long long) (unsigned long) ((ru).ru_nvcsw) : (unsigned long long) ((ru).ru_nvcsw))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("ru_nivcsw"); tprintf_string("%llu", (sizeof((ru).ru_nivcsw) == sizeof(char) ? (unsigned long long) (unsigned char) ((ru).ru_nivcsw) : sizeof((ru).ru_nivcsw) == sizeof(short) ? (unsigned long long) (unsigned short) ((ru).ru_nivcsw) : sizeof((ru).ru_nivcsw) == sizeof(int) ? (unsigned long long) (unsigned int) ((ru).ru_nivcsw) : sizeof((ru).ru_nivcsw) == sizeof(long) ? (unsigned long long) (unsigned long) ((ru).ru_nivcsw) : (unsigned long long) ((ru).ru_nivcsw))); } while (0);
 }
 tprint_struct_end();
}
