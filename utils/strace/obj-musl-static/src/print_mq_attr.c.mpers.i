...
const struct xlat mq_attr_flags[1] = { {
 ...
 .size = (sizeof(mq_attr_flags_xdata) / sizeof((mq_attr_flags_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__((mq_attr_flags_xdata)), __typeof__(&(mq_attr_flags_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((unsigned) (00004000))
  ,
...
MPERS_PRINTER_DECL(void, printmqattr, struct tcb *const tcp, const kernel_ulong_t addr, const _Bool decode_flags)
{
 ...
 if (decode_flags) {
  ...
  tprint_struct_begin();
  do { tprints_field_name("mq_flags"); tprintf_string("%#llx", (sizeof((attr).mq_flags) == sizeof(char) ? (unsigned long long) (unsigned char) ((attr).mq_flags) : sizeof((attr).mq_flags) == sizeof(short) ? (unsigned long long) (unsigned short) ((attr).mq_flags) : sizeof((attr).mq_flags) == sizeof(int) ? (unsigned long long) (unsigned int) ((attr).mq_flags) : sizeof((attr).mq_flags) == sizeof(long) ? (unsigned long long) (unsigned long) ((attr).mq_flags) : (unsigned long long) ((attr).mq_flags))); } while (0);
 }
 tprint_struct_next();
 do { tprints_field_name("mq_maxmsg"); tprintf_string("%lld", (sizeof((attr).mq_maxmsg) == sizeof(char) ? (long long) (signed char) ((attr).mq_maxmsg) : sizeof((attr).mq_maxmsg) == sizeof(short) ? (long long) (short) ((attr).mq_maxmsg) : sizeof((attr).mq_maxmsg) == sizeof(int) ? (long long) (int) ((attr).mq_maxmsg) : sizeof((attr).mq_maxmsg) == sizeof(long) ? (long long) (long) ((attr).mq_maxmsg) : (long long) ((attr).mq_maxmsg))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("mq_msgsize"); tprintf_string("%lld", (sizeof((attr).mq_msgsize) == sizeof(char) ? (long long) (signed char) ((attr).mq_msgsize) : sizeof((attr).mq_msgsize) == sizeof(short) ? (long long) (short) ((attr).mq_msgsize) : sizeof((attr).mq_msgsize) == sizeof(int) ? (long long) (int) ((attr).mq_msgsize) : sizeof((attr).mq_msgsize) == sizeof(long) ? (long long) (long) ((attr).mq_msgsize) : (long long) ((attr).mq_msgsize))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("mq_curmsgs"); tprintf_string("%lld", (sizeof((attr).mq_curmsgs) == sizeof(char) ? (long long) (signed char) ((attr).mq_curmsgs) : sizeof((attr).mq_curmsgs) == sizeof(short) ? (long long) (short) ((attr).mq_curmsgs) : sizeof((attr).mq_curmsgs) == sizeof(int) ? (long long) (int) ((attr).mq_curmsgs) : sizeof((attr).mq_curmsgs) == sizeof(long) ? (long long) (long) ((attr).mq_curmsgs) : (long long) ((attr).mq_curmsgs))); } while (0);
 tprint_struct_end();
}
