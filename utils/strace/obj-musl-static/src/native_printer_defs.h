...
.fetch_struct_iovec = fetch_struct_iovec,
...
.decode_prstatus_regset = decode_prstatus_regset,
.decode_fpregset = decode_fpregset,
.decode_pt_regs = decode_pt_regs,
.decode_pt_fpregs = decode_pt_fpregs,
.rtc_ioctl = rtc_ioctl,
