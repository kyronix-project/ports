...
const struct xlat msgctl_flags[1] = { {
 ...
 .size = (sizeof(msgctl_flags_xdata) / sizeof((msgctl_flags_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__((msgctl_flags_xdata)), __typeof__(&(msgctl_flags_xdata)[0])))]) * 0)),
 .type = XT_SORTED,
 .flags_mask = 0
  | ((unsigned) (0))
  | ((unsigned) (1))
       ...
       const unsigned int cmd)
{
 ...
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&info)), (void *) (&info)))
  return;
 tprint_struct_begin();
 do { tprints_field_name("msgpool"); tprintf_string("%lld", (sizeof((info).msgpool) == sizeof(char) ? (long long) (signed char) ((info).msgpool) : sizeof((info).msgpool) == sizeof(short) ? (long long) (short) ((info).msgpool) : sizeof((info).msgpool) == sizeof(int) ? (long long) (int) ((info).msgpool) : sizeof((info).msgpool) == sizeof(long) ? (long long) (long) ((info).msgpool) : (long long) ((info).msgpool))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("msgmap"); tprintf_string("%lld", (sizeof((info).msgmap) == sizeof(char) ? (long long) (signed char) ((info).msgmap) : sizeof((info).msgmap) == sizeof(short) ? (long long) (short) ((info).msgmap) : sizeof((info).msgmap) == sizeof(int) ? (long long) (int) ((info).msgmap) : sizeof((info).msgmap) == sizeof(long) ? (long long) (long) ((info).msgmap) : (long long) ((info).msgmap))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("msgmax"); tprintf_string("%lld", (sizeof((info).msgmax) == sizeof(char) ? (long long) (signed char) ((info).msgmax) : sizeof((info).msgmax) == sizeof(short) ? (long long) (short) ((info).msgmax) : sizeof((info).msgmax) == sizeof(int) ? (long long) (int) ((info).msgmax) : sizeof((info).msgmax) == sizeof(long) ? (long long) (long) ((info).msgmax) : (long long) ((info).msgmax))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("msgmnb"); tprintf_string("%lld", (sizeof((info).msgmnb) == sizeof(char) ? (long long) (signed char) ((info).msgmnb) : sizeof((info).msgmnb) == sizeof(short) ? (long long) (short) ((info).msgmnb) : sizeof((info).msgmnb) == sizeof(int) ? (long long) (int) ((info).msgmnb) : sizeof((info).msgmnb) == sizeof(long) ? (long long) (long) ((info).msgmnb) : (long long) ((info).msgmnb))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("msgmni"); tprintf_string("%lld", (sizeof((info).msgmni) == sizeof(char) ? (long long) (signed char) ((info).msgmni) : sizeof((info).msgmni) == sizeof(short) ? (long long) (short) ((info).msgmni) : sizeof((info).msgmni) == sizeof(int) ? (long long) (int) ((info).msgmni) : sizeof((info).msgmni) == sizeof(long) ? (long long) (long) ((info).msgmni) : (long long) ((info).msgmni))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("msgssz"); tprintf_string("%lld", (sizeof((info).msgssz) == sizeof(char) ? (long long) (signed char) ((info).msgssz) : sizeof((info).msgssz) == sizeof(short) ? (long long) (short) ((info).msgssz) : sizeof((info).msgssz) == sizeof(int) ? (long long) (int) ((info).msgssz) : sizeof((info).msgssz) == sizeof(long) ? (long long) (long) ((info).msgssz) : (long long) ((info).msgssz))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("msgtql"); tprintf_string("%lld", (sizeof((info).msgtql) == sizeof(char) ? (long long) (signed char) ((info).msgtql) : sizeof((info).msgtql) == sizeof(short) ? (long long) (short) ((info).msgtql) : sizeof((info).msgtql) == sizeof(int) ? (long long) (int) ((info).msgtql) : sizeof((info).msgtql) == sizeof(long) ? (long long) (long) ((info).msgtql) : (long long) ((info).msgtql))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("msgseg"); tprintf_string("%llu", (sizeof((info).msgseg) == sizeof(char) ? (unsigned long long) (unsigned char) ((info).msgseg) : sizeof((info).msgseg) == sizeof(short) ? (unsigned long long) (unsigned short) ((info).msgseg) : sizeof((info).msgseg) == sizeof(int) ? (unsigned long long) (unsigned int) ((info).msgseg) : sizeof((info).msgseg) == sizeof(long) ? (unsigned long long) (unsigned long) ((info).msgseg) : (unsigned long long) ((info).msgseg))); } while (0);
 tprint_struct_end();
}
int sys_msgctl(struct tcb *tcp)
{
 ...
 if ((!((tcp)->flags & 0x04))) {
  ...
  do { tprint_flags_begin(); if ((tcp->u_arg[1]) & 0x0100) { print_xlat_ex((0x0100), "IPC_64", XLAT_STYLE_DEFAULT); tprint_flags_or(); } printxval((msgctl_flags), (tcp->u_arg[1]) & ~0x0100, "MSG_???"); tprint_flags_end(); } while (0);
  switch (cmd) {
  case 1:
