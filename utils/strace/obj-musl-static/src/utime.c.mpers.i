...
int sys_utime(struct tcb *tcp)
{
 ...
 if (!umoven_or_printaddr((tcp), (tcp->u_arg[1]), sizeof(*(&u)), (void *) (&u))) {
  tprint_struct_begin();
  do { tprints_field_name("actime"); tprintf_string("%lld", (sizeof((u).actime) == sizeof(char) ? (long long) (signed char) ((u).actime) : sizeof((u).actime) == sizeof(short) ? (long long) (short) ((u).actime) : sizeof((u).actime) == sizeof(int) ? (long long) (int) ((u).actime) : sizeof((u).actime) == sizeof(long) ? (long long) (long) ((u).actime) : (long long) ((u).actime))); } while (0);
  tprints_comment(sprinttime(u.actime));
  tprint_struct_next();
  do { tprints_field_name("modtime"); tprintf_string("%lld", (sizeof((u).modtime) == sizeof(char) ? (long long) (signed char) ((u).modtime) : sizeof((u).modtime) == sizeof(short) ? (long long) (short) ((u).modtime) : sizeof((u).modtime) == sizeof(int) ? (long long) (int) ((u).modtime) : sizeof((u).modtime) == sizeof(long) ? (long long) (long) ((u).modtime) : (long long) ((u).modtime))); } while (0);
