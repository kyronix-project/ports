...
#define fetch_struct_flock64 MPERS_PRINTER_NAME(fetch_struct_flock64)
 ...
 _Bool (*fetch_struct_iovec)(struct tcb *const tcp, const kernel_ulong_t addr, void *const dest);
#define fetch_struct_iovec MPERS_PRINTER_NAME(fetch_struct_iovec)
...
#define hdio_ioctl MPERS_PRINTER_NAME(hdio_ioctl)
 ...
 int (*kd_mpers_ioctl)(struct tcb *const tcp, const unsigned int code, const kernel_ulong_t arg);
#define kd_mpers_ioctl MPERS_PRINTER_NAME(kd_mpers_ioctl)
...
#define print_siginfo_array MPERS_PRINTER_NAME(print_siginfo_array)
 ...
 void (*decode_prstatus_regset)(struct tcb *const tcp, const kernel_ulong_t addr, const kernel_ulong_t size);
#define decode_prstatus_regset MPERS_PRINTER_NAME(decode_prstatus_regset)

 void (*decode_fpregset)(struct tcb *const tcp, const kernel_ulong_t addr, const kernel_ulong_t size);
#define decode_fpregset MPERS_PRINTER_NAME(decode_fpregset)

 void (*decode_pt_regs)(struct tcb *const tcp, const kernel_ulong_t addr);
#define decode_pt_regs MPERS_PRINTER_NAME(decode_pt_regs)

 void (*decode_pt_fpregs)(struct tcb *const tcp, const kernel_ulong_t addr);
#define decode_pt_fpregs MPERS_PRINTER_NAME(decode_pt_fpregs)
