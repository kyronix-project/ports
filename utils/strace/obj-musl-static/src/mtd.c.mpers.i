...
const struct xlat mtd_mode_options[1] = { {
 ...
 .size = (sizeof(mtd_mode_options_xdata) / sizeof((mtd_mode_options_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__((mtd_mode_options_xdata)), __typeof__(&(mtd_mode_options_xdata)[0])))]) * 0)),
 .type = XT_INDEXED,
 .flags_mask = 0
...
const struct xlat mtd_file_mode_options[1] = { {
 ...
 .size = (sizeof(mtd_file_mode_options_xdata) / sizeof((mtd_file_mode_options_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__((mtd_file_mode_options_xdata)), __typeof__(&(mtd_file_mode_options_xdata)[0])))]) * 0)),
 .type = XT_INDEXED,
 .flags_mask = 0
...
const struct xlat mtd_type_options[1] = { {
 ...
 .size = (sizeof(mtd_type_options_xdata) / sizeof((mtd_type_options_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__((mtd_type_options_xdata)), __typeof__(&(mtd_type_options_xdata)[0])))]) * 0)),
 .type = XT_INDEXED,
 .flags_mask = 0
  | ((unsigned) (0))
  | ((unsigned) (1))
...
const struct xlat mtd_flags_options[1] = { {
 ...
 .size = (sizeof(mtd_flags_options_xdata) / sizeof((mtd_flags_options_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__((mtd_flags_options_xdata)), __typeof__(&(mtd_flags_options_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((unsigned) (0x400))
  | ((unsigned) (0x800))
...
const struct xlat mtd_otp_options[1] = { {
 ...
 .size = (sizeof(mtd_otp_options_xdata) / sizeof((mtd_otp_options_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__((mtd_otp_options_xdata)), __typeof__(&(mtd_otp_options_xdata)[0])))]) * 0)),
 .type = XT_INDEXED,
 .flags_mask = 0
  | ((unsigned) (0))
  | ((unsigned) (1))
...
const struct xlat mtd_nandecc_options[1] = { {
 ...
 .size = (sizeof(mtd_nandecc_options_xdata) / sizeof((mtd_nandecc_options_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__((mtd_nandecc_options_xdata)), __typeof__(&(mtd_nandecc_options_xdata)[0])))]) * 0)),
 .type = XT_INDEXED,
 .flags_mask = 0
  | ((unsigned) (0))
  | ((unsigned) (1))
...
decode_erase_info_user64(struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&einfo64)), (void *) (&einfo64)))
  return;
 tprint_struct_begin();
 do { tprints_field_name("start"); tprintf_string("%#llx", (sizeof((einfo64).start) == sizeof(char) ? (unsigned long long) (unsigned char) ((einfo64).start) : sizeof((einfo64).start) == sizeof(short) ? (unsigned long long) (unsigned short) ((einfo64).start) : sizeof((einfo64).start) == sizeof(int) ? (unsigned long long) (unsigned int) ((einfo64).start) : sizeof((einfo64).start) == sizeof(long) ? (unsigned long long) (unsigned long) ((einfo64).start) : (unsigned long long) ((einfo64).start))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("length"); tprintf_string("%#llx", (sizeof((einfo64).length) == sizeof(char) ? (unsigned long long) (unsigned char) ((einfo64).length) : sizeof((einfo64).length) == sizeof(short) ? (unsigned long long) (unsigned short) ((einfo64).length) : sizeof((einfo64).length) == sizeof(int) ? (unsigned long long) (unsigned int) ((einfo64).length) : sizeof((einfo64).length) == sizeof(long) ? (unsigned long long) (unsigned long) ((einfo64).length) : (unsigned long long) ((einfo64).length))); } while (0);
 tprint_struct_end();
}
static void
decode_mtd_oob_buf(struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&mbuf)), (void *) (&mbuf)))
  return;
 tprint_struct_begin();
 do { tprints_field_name("start"); tprintf_string("%#llx", (sizeof((mbuf).start) == sizeof(char) ? (unsigned long long) (unsigned char) ((mbuf).start) : sizeof((mbuf).start) == sizeof(short) ? (unsigned long long) (unsigned short) ((mbuf).start) : sizeof((mbuf).start) == sizeof(int) ? (unsigned long long) (unsigned int) ((mbuf).start) : sizeof((mbuf).start) == sizeof(long) ? (unsigned long long) (unsigned long) ((mbuf).start) : (unsigned long long) ((mbuf).start))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("length"); tprintf_string("%#llx", (sizeof((mbuf).length) == sizeof(char) ? (unsigned long long) (unsigned char) ((mbuf).length) : sizeof((mbuf).length) == sizeof(short) ? (unsigned long long) (unsigned short) ((mbuf).length) : sizeof((mbuf).length) == sizeof(int) ? (unsigned long long) (unsigned int) ((mbuf).length) : sizeof((mbuf).length) == sizeof(long) ? (unsigned long long) (unsigned long) ((mbuf).length) : (unsigned long long) ((mbuf).length))); } while (0);
 tprint_struct_next();
...
decode_mtd_oob_buf64(struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&mbuf64)), (void *) (&mbuf64)))
  return;
 tprint_struct_begin();
 do { tprints_field_name("start"); tprintf_string("%#llx", (sizeof((mbuf64).start) == sizeof(char) ? (unsigned long long) (unsigned char) ((mbuf64).start) : sizeof((mbuf64).start) == sizeof(short) ? (unsigned long long) (unsigned short) ((mbuf64).start) : sizeof((mbuf64).start) == sizeof(int) ? (unsigned long long) (unsigned int) ((mbuf64).start) : sizeof((mbuf64).start) == sizeof(long) ? (unsigned long long) (unsigned long) ((mbuf64).start) : (unsigned long long) ((mbuf64).start))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("length"); tprintf_string("%#llx", (sizeof((mbuf64).length) == sizeof(char) ? (unsigned long long) (unsigned char) ((mbuf64).length) : sizeof((mbuf64).length) == sizeof(short) ? (unsigned long long) (unsigned short) ((mbuf64).length) : sizeof((mbuf64).length) == sizeof(int) ? (unsigned long long) (unsigned int) ((mbuf64).length) : sizeof((mbuf64).length) == sizeof(long) ? (unsigned long long) (unsigned long) ((mbuf64).length) : (unsigned long long) ((mbuf64).length))); } while (0);
 tprint_struct_next();
...
decode_otp_info(struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&oinfo)), (void *) (&oinfo)))
  return;
 tprint_struct_begin();
 do { tprints_field_name("start"); tprintf_string("%#llx", (sizeof((oinfo).start) == sizeof(char) ? (unsigned long long) (unsigned char) ((oinfo).start) : sizeof((oinfo).start) == sizeof(short) ? (unsigned long long) (unsigned short) ((oinfo).start) : sizeof((oinfo).start) == sizeof(int) ? (unsigned long long) (unsigned int) ((oinfo).start) : sizeof((oinfo).start) == sizeof(long) ? (unsigned long long) (unsigned long) ((oinfo).start) : (unsigned long long) ((oinfo).start))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("length"); tprintf_string("%#llx", (sizeof((oinfo).length) == sizeof(char) ? (unsigned long long) (unsigned char) ((oinfo).length) : sizeof((oinfo).length) == sizeof(short) ? (unsigned long long) (unsigned short) ((oinfo).length) : sizeof((oinfo).length) == sizeof(int) ? (unsigned long long) (unsigned int) ((oinfo).length) : sizeof((oinfo).length) == sizeof(long) ? (unsigned long long) (unsigned long) ((oinfo).length) : (unsigned long long) ((oinfo).length))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("locked"); tprintf_string("%llu", (sizeof((oinfo).locked) == sizeof(char) ? (unsigned long long) (unsigned char) ((oinfo).locked) : sizeof((oinfo).locked) == sizeof(short) ? (unsigned long long) (unsigned short) ((oinfo).locked) : sizeof((oinfo).locked) == sizeof(int) ? (unsigned long long) (unsigned int) ((oinfo).locked) : sizeof((oinfo).locked) == sizeof(long) ? (unsigned long long) (unsigned long) ((oinfo).locked) : (unsigned long long) ((oinfo).locked))); } while (0);
 tprint_struct_end();
}
static void
...
decode_mtd_write_req(struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&mreq)), (void *) (&mreq)))
  return;
 tprint_struct_begin();
 do { tprints_field_name("start"); tprintf_string("%#llx", (sizeof((mreq).start) == sizeof(char) ? (unsigned long long) (unsigned char) ((mreq).start) : sizeof((mreq).start) == sizeof(short) ? (unsigned long long) (unsigned short) ((mreq).start) : sizeof((mreq).start) == sizeof(int) ? (unsigned long long) (unsigned int) ((mreq).start) : sizeof((mreq).start) == sizeof(long) ? (unsigned long long) (unsigned long) ((mreq).start) : (unsigned long long) ((mreq).start))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("len"); tprintf_string("%#llx", (sizeof((mreq).len) == sizeof(char) ? (unsigned long long) (unsigned char) ((mreq).len) : sizeof((mreq).len) == sizeof(short) ? (unsigned long long) (unsigned short) ((mreq).len) : sizeof((mreq).len) == sizeof(int) ? (unsigned long long) (unsigned int) ((mreq).len) : sizeof((mreq).len) == sizeof(long) ? (unsigned long long) (unsigned long) ((mreq).len) : (unsigned long long) ((mreq).len))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("ooblen"); tprintf_string("%#llx", (sizeof((mreq).ooblen) == sizeof(char) ? (unsigned long long) (unsigned char) ((mreq).ooblen) : sizeof((mreq).ooblen) == sizeof(short) ? (unsigned long long) (unsigned short) ((mreq).ooblen) : sizeof((mreq).ooblen) == sizeof(int) ? (unsigned long long) (unsigned int) ((mreq).ooblen) : sizeof((mreq).ooblen) == sizeof(long) ? (unsigned long long) (unsigned long) ((mreq).ooblen) : (unsigned long long) ((mreq).ooblen))); } while (0);
 tprint_struct_next();
...
decode_mtd_info_user(struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 tprint_struct_next();
 do { tprints_field_name("size"); tprintf_string("%#llx", (sizeof((minfo).size) == sizeof(char) ? (unsigned long long) (unsigned char) ((minfo).size) : sizeof((minfo).size) == sizeof(short) ? (unsigned long long) (unsigned short) ((minfo).size) : sizeof((minfo).size) == sizeof(int) ? (unsigned long long) (unsigned int) ((minfo).size) : sizeof((minfo).size) == sizeof(long) ? (unsigned long long) (unsigned long) ((minfo).size) : (unsigned long long) ((minfo).size))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("erasesize"); tprintf_string("%#llx", (sizeof((minfo).erasesize) == sizeof(char) ? (unsigned long long) (unsigned char) ((minfo).erasesize) : sizeof((minfo).erasesize) == sizeof(short) ? (unsigned long long) (unsigned short) ((minfo).erasesize) : sizeof((minfo).erasesize) == sizeof(int) ? (unsigned long long) (unsigned int) ((minfo).erasesize) : sizeof((minfo).erasesize) == sizeof(long) ? (unsigned long long) (unsigned long) ((minfo).erasesize) : (unsigned long long) ((minfo).erasesize))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("writesize"); tprintf_string("%#llx", (sizeof((minfo).writesize) == sizeof(char) ? (unsigned long long) (unsigned char) ((minfo).writesize) : sizeof((minfo).writesize) == sizeof(short) ? (unsigned long long) (unsigned short) ((minfo).writesize) : sizeof((minfo).writesize) == sizeof(int) ? (unsigned long long) (unsigned int) ((minfo).writesize) : sizeof((minfo).writesize) == sizeof(long) ? (unsigned long long) (unsigned long) ((minfo).writesize) : (unsigned long long) ((minfo).writesize))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("oobsize"); tprintf_string("%#llx", (sizeof((minfo).oobsize) == sizeof(char) ? (unsigned long long) (unsigned char) ((minfo).oobsize) : sizeof((minfo).oobsize) == sizeof(short) ? (unsigned long long) (unsigned short) ((minfo).oobsize) : sizeof((minfo).oobsize) == sizeof(int) ? (unsigned long long) (unsigned int) ((minfo).oobsize) : sizeof((minfo).oobsize) == sizeof(long) ? (unsigned long long) (unsigned long) ((minfo).oobsize) : (unsigned long long) ((minfo).oobsize))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("padding"); tprintf_string("%#llx", (sizeof((minfo).padding) == sizeof(char) ? (unsigned long long) (unsigned char) ((minfo).padding) : sizeof((minfo).padding) == sizeof(short) ? (unsigned long long) (unsigned short) ((minfo).padding) : sizeof((minfo).padding) == sizeof(int) ? (unsigned long long) (unsigned int) ((minfo).padding) : sizeof((minfo).padding) == sizeof(long) ? (unsigned long long) (unsigned long) ((minfo).padding) : (unsigned long long) ((minfo).padding))); } while (0);
 tprint_struct_end();
}
static _Bool
       ...
       void *data)
{
 print_local_array_ex(tcp, elem_buf, 2, sizeof(int),
        print_xint_array_member, ((void*)0), 0, ((void*)0), ((void*)0));
 return 1;
}
static void
decode_nand_oobinfo(struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 tprint_struct_next();
 do { tprints_field_name("eccbytes"); tprintf_string("%#llx", (sizeof((ninfo).eccbytes) == sizeof(char) ? (unsigned long long) (unsigned char) ((ninfo).eccbytes) : sizeof((ninfo).eccbytes) == sizeof(short) ? (unsigned long long) (unsigned short) ((ninfo).eccbytes) : sizeof((ninfo).eccbytes) == sizeof(int) ? (unsigned long long) (unsigned int) ((ninfo).eccbytes) : sizeof((ninfo).eccbytes) == sizeof(long) ? (unsigned long long) (unsigned long) ((ninfo).eccbytes) : (unsigned long long) ((ninfo).eccbytes))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("oobfree"); print_local_array_ex(((tcp)), ((ninfo).oobfree), (sizeof((ninfo).oobfree) / sizeof(((ninfo).oobfree)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__(((ninfo).oobfree)), __typeof__(&((ninfo).oobfree)[0])))]) * 0)), sizeof(((ninfo).oobfree)[0]), ((print_xint32x2_array_member)), ((void*)0), 0, ((void*)0), ((void*)0)); } while (0);
 tprint_struct_next();
 do { tprints_field_name("eccpos"); print_local_array_ex(((tcp)), ((ninfo).eccpos), (sizeof((ninfo).eccpos) / sizeof(((ninfo).eccpos)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__(((ninfo).eccpos)), __typeof__(&((ninfo).eccpos)[0])))]) * 0)), sizeof(((ninfo).eccpos)[0]), ((print_xint_array_member)), ((void*)0), 0, ((void*)0), ((void*)0)); } while (0);
 tprint_struct_end();
}
static _Bool
    ...
    size_t elem_size, void *data)
{
 ...
 tprint_struct_begin();
 do { tprints_field_name("offset"); tprintf_string("%#llx", (sizeof((*p).offset) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).offset) : sizeof((*p).offset) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).offset) : sizeof((*p).offset) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).offset) : sizeof((*p).offset) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).offset) : (unsigned long long) ((*p).offset))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("length"); tprintf_string("%#llx", (sizeof((*p).length) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).length) : sizeof((*p).length) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).length) : sizeof((*p).length) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).length) : sizeof((*p).length) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).length) : (unsigned long long) ((*p).length))); } while (0);
 tprint_struct_end();
 return 1;
}
static void
decode_nand_ecclayout_user(struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&nlay)), (void *) (&nlay)))
  return;
 tprint_struct_begin();
 do { tprints_field_name("eccbytes"); tprintf_string("%#llx", (sizeof((nlay).eccbytes) == sizeof(char) ? (unsigned long long) (unsigned char) ((nlay).eccbytes) : sizeof((nlay).eccbytes) == sizeof(short) ? (unsigned long long) (unsigned short) ((nlay).eccbytes) : sizeof((nlay).eccbytes) == sizeof(int) ? (unsigned long long) (unsigned int) ((nlay).eccbytes) : sizeof((nlay).eccbytes) == sizeof(long) ? (unsigned long long) (unsigned long) ((nlay).eccbytes) : (unsigned long long) ((nlay).eccbytes))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("eccpos"); print_local_array_ex(((tcp)), ((nlay).eccpos), (sizeof((nlay).eccpos) / sizeof(((nlay).eccpos)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__(((nlay).eccpos)), __typeof__(&((nlay).eccpos)[0])))]) * 0)), sizeof(((nlay).eccpos)[0]), ((print_xint_array_member)), ((void*)0), 0, ((void*)0), ((void*)0)); } while (0);
 tprint_struct_next();
 do { tprints_field_name("oobavail"); tprintf_string("%#llx", (sizeof((nlay).oobavail) == sizeof(char) ? (unsigned long long) (unsigned char) ((nlay).oobavail) : sizeof((nlay).oobavail) == sizeof(short) ? (unsigned long long) (unsigned short) ((nlay).oobavail) : sizeof((nlay).oobavail) == sizeof(int) ? (unsigned long long) (unsigned int) ((nlay).oobavail) : sizeof((nlay).oobavail) == sizeof(long) ? (unsigned long long) (unsigned long) ((nlay).oobavail) : (unsigned long long) ((nlay).oobavail))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("oobfree"); print_local_array_ex(((tcp)), ((nlay).oobfree), (sizeof((nlay).oobfree) / sizeof(((nlay).oobfree)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__(((nlay).oobfree)), __typeof__(&((nlay).oobfree)[0])))]) * 0)), sizeof(((nlay).oobfree)[0]), ((print_nand_oobfree_array_member)), ((void*)0), 0, ((void*)0), ((void*)0)); } while (0);
 tprint_struct_end();
}
static void
decode_mtd_ecc_stats(struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&es)), (void *) (&es)))
  return;
 tprint_struct_begin();
 do { tprints_field_name("corrected"); tprintf_string("%#llx", (sizeof((es).corrected) == sizeof(char) ? (unsigned long long) (unsigned char) ((es).corrected) : sizeof((es).corrected) == sizeof(short) ? (unsigned long long) (unsigned short) ((es).corrected) : sizeof((es).corrected) == sizeof(int) ? (unsigned long long) (unsigned int) ((es).corrected) : sizeof((es).corrected) == sizeof(long) ? (unsigned long long) (unsigned long) ((es).corrected) : (unsigned long long) ((es).corrected))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("failed"); tprintf_string("%#llx", (sizeof((es).failed) == sizeof(char) ? (unsigned long long) (unsigned char) ((es).failed) : sizeof((es).failed) == sizeof(short) ? (unsigned long long) (unsigned short) ((es).failed) : sizeof((es).failed) == sizeof(int) ? (unsigned long long) (unsigned int) ((es).failed) : sizeof((es).failed) == sizeof(long) ? (unsigned long long) (unsigned long) ((es).failed) : (unsigned long long) ((es).failed))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("badblocks"); tprintf_string("%#llx", (sizeof((es).badblocks) == sizeof(char) ? (unsigned long long) (unsigned char) ((es).badblocks) : sizeof((es).badblocks) == sizeof(short) ? (unsigned long long) (unsigned short) ((es).badblocks) : sizeof((es).badblocks) == sizeof(int) ? (unsigned long long) (unsigned int) ((es).badblocks) : sizeof((es).badblocks) == sizeof(long) ? (unsigned long long) (unsigned long) ((es).badblocks) : (unsigned long long) ((es).badblocks))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("bbtblocks"); tprintf_string("%#llx", (sizeof((es).bbtblocks) == sizeof(char) ? (unsigned long long) (unsigned char) ((es).bbtblocks) : sizeof((es).bbtblocks) == sizeof(short) ? (unsigned long long) (unsigned short) ((es).bbtblocks) : sizeof((es).bbtblocks) == sizeof(int) ? (unsigned long long) (unsigned int) ((es).bbtblocks) : sizeof((es).bbtblocks) == sizeof(long) ? (unsigned long long) (unsigned long) ((es).bbtblocks) : (unsigned long long) ((es).bbtblocks))); } while (0);
 tprint_struct_end();
}
 ...
 case (((2U|1U) << (((0 +8)+8)+14)) | ((('M')) << (0 +8)) | (((8)) << 0) | ((((sizeof(struct region_info_user)))) << ((0 +8)+8))):
  if ((!((tcp)->flags & 0x04))) {
   ...
   if (umoven_or_printaddr((tcp), (arg), sizeof(*(&rinfo)), (void *) (&rinfo)))
    break;
   tprint_struct_begin();
   do { tprints_field_name("regionindex"); tprintf_string("%#llx", (sizeof((rinfo).regionindex) == sizeof(char) ? (unsigned long long) (unsigned char) ((rinfo).regionindex) : sizeof((rinfo).regionindex) == sizeof(short) ? (unsigned long long) (unsigned short) ((rinfo).regionindex) : sizeof((rinfo).regionindex) == sizeof(int) ? (unsigned long long) (unsigned int) ((rinfo).regionindex) : sizeof((rinfo).regionindex) == sizeof(long) ? (unsigned long long) (unsigned long) ((rinfo).regionindex) : (unsigned long long) ((rinfo).regionindex))); } while (0);
   return 0;
  } else {
   struct region_info_user rinfo;
   if (!((tcp)->u_error != 0) && !umoven((tcp), (arg), sizeof(*(&rinfo)), (void *) (&rinfo))) {
    tprint_struct_next();
    do { tprints_field_name("offset"); tprintf_string("%#llx", (sizeof((rinfo).offset) == sizeof(char) ? (unsigned long long) (unsigned char) ((rinfo).offset) : sizeof((rinfo).offset) == sizeof(short) ? (unsigned long long) (unsigned short) ((rinfo).offset) : sizeof((rinfo).offset) == sizeof(int) ? (unsigned long long) (unsigned int) ((rinfo).offset) : sizeof((rinfo).offset) == sizeof(long) ? (unsigned long long) (unsigned long) ((rinfo).offset) : (unsigned long long) ((rinfo).offset))); } while (0);
    tprint_struct_next();
    do { tprints_field_name("erasesize"); tprintf_string("%#llx", (sizeof((rinfo).erasesize) == sizeof(char) ? (unsigned long long) (unsigned char) ((rinfo).erasesize) : sizeof((rinfo).erasesize) == sizeof(short) ? (unsigned long long) (unsigned short) ((rinfo).erasesize) : sizeof((rinfo).erasesize) == sizeof(int) ? (unsigned long long) (unsigned int) ((rinfo).erasesize) : sizeof((rinfo).erasesize) == sizeof(long) ? (unsigned long long) (unsigned long) ((rinfo).erasesize) : (unsigned long long) ((rinfo).erasesize))); } while (0);
    tprint_struct_next();
    do { tprints_field_name("numblocks"); tprintf_string("%#llx", (sizeof((rinfo).numblocks) == sizeof(char) ? (unsigned long long) (unsigned char) ((rinfo).numblocks) : sizeof((rinfo).numblocks) == sizeof(short) ? (unsigned long long) (unsigned short) ((rinfo).numblocks) : sizeof((rinfo).numblocks) == sizeof(int) ? (unsigned long long) (unsigned int) ((rinfo).numblocks) : sizeof((rinfo).numblocks) == sizeof(long) ? (unsigned long long) (unsigned long) ((rinfo).numblocks) : (unsigned long long) ((rinfo).numblocks))); } while (0);
   }
   tprint_struct_end();
   break;
  }
