...
#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (11)
...
#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (14)
...
const struct xlat shmctl_flags[1] = { {
 ...
 .size = (sizeof(shmctl_flags_xdata) / sizeof((shmctl_flags_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__((shmctl_flags_xdata)), __typeof__(&(shmctl_flags_xdata)[0])))]) * 0)),
 .type = XT_SORTED,
 .flags_mask = 0
  | ((unsigned) (0))
  | ((unsigned) (1))
...
{
 tprint_struct_begin();
 do { tprints_field_name("uid"); do { if ((sizeof((*p).uid) == sizeof(char) ? (long long) (signed char) ((*p).uid) : sizeof((*p).uid) == sizeof(short) ? (long long) (short) ((*p).uid) : sizeof((*p).uid) == sizeof(int) ? (long long) (int) ((*p).uid) : sizeof((*p).uid) == sizeof(long) ? (long long) (long) ((*p).uid) : (long long) ((*p).uid)) == -1LL) tprintf_string("%lld", (sizeof(-1) == sizeof(char) ? (long long) (signed char) (-1) : sizeof(-1) == sizeof(short) ? (long long) (short) (-1) : sizeof(-1) == sizeof(int) ? (long long) (int) (-1) : sizeof(-1) == sizeof(long) ? (long long) (long) (-1) : (long long) (-1))); else tprintf_string("%llu", (sizeof((*p).uid) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).uid) : sizeof((*p).uid) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).uid) : sizeof((*p).uid) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).uid) : sizeof((*p).uid) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).uid) : (unsigned long long) ((*p).uid))); } while (0); } while (0);
 tprint_struct_next();
 do { tprints_field_name("gid"); do { if ((sizeof((*p).gid) == sizeof(char) ? (long long) (signed char) ((*p).gid) : sizeof((*p).gid) == sizeof(short) ? (long long) (short) ((*p).gid) : sizeof((*p).gid) == sizeof(int) ? (long long) (int) ((*p).gid) : sizeof((*p).gid) == sizeof(long) ? (long long) (long) ((*p).gid) : (long long) ((*p).gid)) == -1LL) tprintf_string("%lld", (sizeof(-1) == sizeof(char) ? (long long) (signed char) (-1) : sizeof(-1) == sizeof(short) ? (long long) (short) (-1) : sizeof(-1) == sizeof(int) ? (long long) (int) (-1) : sizeof(-1) == sizeof(long) ? (long long) (long) (-1) : (long long) (-1))); else tprintf_string("%llu", (sizeof((*p).gid) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).gid) : sizeof((*p).gid) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).gid) : sizeof((*p).gid) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).gid) : sizeof((*p).gid) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).gid) : (unsigned long long) ((*p).gid))); } while (0); } while (0);
 tprint_struct_next();
 ...
 if (cmd != 1) {
  tprint_struct_next();
  do { tprints_field_name("key"); tprintf_string("%llu", (sizeof((*p).key) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).key) : sizeof((*p).key) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).key) : sizeof((*p).key) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).key) : sizeof((*p).key) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).key) : (unsigned long long) ((*p).key))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("cuid"); do { if ((sizeof((*p).cuid) == sizeof(char) ? (long long) (signed char) ((*p).cuid) : sizeof((*p).cuid) == sizeof(short) ? (long long) (short) ((*p).cuid) : sizeof((*p).cuid) == sizeof(int) ? (long long) (int) ((*p).cuid) : sizeof((*p).cuid) == sizeof(long) ? (long long) (long) ((*p).cuid) : (long long) ((*p).cuid)) == -1LL) tprintf_string("%lld", (sizeof(-1) == sizeof(char) ? (long long) (signed char) (-1) : sizeof(-1) == sizeof(short) ? (long long) (short) (-1) : sizeof(-1) == sizeof(int) ? (long long) (int) (-1) : sizeof(-1) == sizeof(long) ? (long long) (long) (-1) : (long long) (-1))); else tprintf_string("%llu", (sizeof((*p).cuid) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).cuid) : sizeof((*p).cuid) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).cuid) : sizeof((*p).cuid) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).cuid) : sizeof((*p).cuid) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).cuid) : (unsigned long long) ((*p).cuid))); } while (0); } while (0);
  tprint_struct_next();
  do { tprints_field_name("cgid"); do { if ((sizeof((*p).cgid) == sizeof(char) ? (long long) (signed char) ((*p).cgid) : sizeof((*p).cgid) == sizeof(short) ? (long long) (short) ((*p).cgid) : sizeof((*p).cgid) == sizeof(int) ? (long long) (int) ((*p).cgid) : sizeof((*p).cgid) == sizeof(long) ? (long long) (long) ((*p).cgid) : (long long) ((*p).cgid)) == -1LL) tprintf_string("%lld", (sizeof(-1) == sizeof(char) ? (long long) (signed char) (-1) : sizeof(-1) == sizeof(short) ? (long long) (short) (-1) : sizeof(-1) == sizeof(int) ? (long long) (int) (-1) : sizeof(-1) == sizeof(long) ? (long long) (long) (-1) : (long long) (-1))); else tprintf_string("%llu", (sizeof((*p).cgid) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).cgid) : sizeof((*p).cgid) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).cgid) : sizeof((*p).cgid) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).cgid) : sizeof((*p).cgid) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).cgid) : (unsigned long long) ((*p).cgid))); } while (0); } while (0);
 }
 tprint_struct_end();
}
static void
        ...
        const unsigned int cmd)
{
 ...
 if (cmd != 1) {
  tprint_struct_next();
  do { tprints_field_name("shm_segsz"); tprintf_string("%llu", (sizeof((shmid_ds).shm_segsz) == sizeof(char) ? (unsigned long long) (unsigned char) ((shmid_ds).shm_segsz) : sizeof((shmid_ds).shm_segsz) == sizeof(short) ? (unsigned long long) (unsigned short) ((shmid_ds).shm_segsz) : sizeof((shmid_ds).shm_segsz) == sizeof(int) ? (unsigned long long) (unsigned int) ((shmid_ds).shm_segsz) : sizeof((shmid_ds).shm_segsz) == sizeof(long) ? (unsigned long long) (unsigned long) ((shmid_ds).shm_segsz) : (unsigned long long) ((shmid_ds).shm_segsz))); } while (0);
  tprint_struct_next();
  ...
  tprint_struct_next();
  do { tprints_field_name("shm_nattch"); tprintf_string("%llu", (sizeof((shmid_ds).shm_nattch) == sizeof(char) ? (unsigned long long) (unsigned char) ((shmid_ds).shm_nattch) : sizeof((shmid_ds).shm_nattch) == sizeof(short) ? (unsigned long long) (unsigned short) ((shmid_ds).shm_nattch) : sizeof((shmid_ds).shm_nattch) == sizeof(int) ? (unsigned long long) (unsigned int) ((shmid_ds).shm_nattch) : sizeof((shmid_ds).shm_nattch) == sizeof(long) ? (unsigned long long) (unsigned long) ((shmid_ds).shm_nattch) : (unsigned long long) ((shmid_ds).shm_nattch))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("shm_atime"); tprintf_string("%llu", (sizeof((shmid_ds).shm_atime) == sizeof(char) ? (unsigned long long) (unsigned char) ((shmid_ds).shm_atime) : sizeof((shmid_ds).shm_atime) == sizeof(short) ? (unsigned long long) (unsigned short) ((shmid_ds).shm_atime) : sizeof((shmid_ds).shm_atime) == sizeof(int) ? (unsigned long long) (unsigned int) ((shmid_ds).shm_atime) : sizeof((shmid_ds).shm_atime) == sizeof(long) ? (unsigned long long) (unsigned long) ((shmid_ds).shm_atime) : (unsigned long long) ((shmid_ds).shm_atime))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("shm_dtime"); tprintf_string("%llu", (sizeof((shmid_ds).shm_dtime) == sizeof(char) ? (unsigned long long) (unsigned char) ((shmid_ds).shm_dtime) : sizeof((shmid_ds).shm_dtime) == sizeof(short) ? (unsigned long long) (unsigned short) ((shmid_ds).shm_dtime) : sizeof((shmid_ds).shm_dtime) == sizeof(int) ? (unsigned long long) (unsigned int) ((shmid_ds).shm_dtime) : sizeof((shmid_ds).shm_dtime) == sizeof(long) ? (unsigned long long) (unsigned long) ((shmid_ds).shm_dtime) : (unsigned long long) ((shmid_ds).shm_dtime))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("shm_ctime"); tprintf_string("%llu", (sizeof((shmid_ds).shm_ctime) == sizeof(char) ? (unsigned long long) (unsigned char) ((shmid_ds).shm_ctime) : sizeof((shmid_ds).shm_ctime) == sizeof(short) ? (unsigned long long) (unsigned short) ((shmid_ds).shm_ctime) : sizeof((shmid_ds).shm_ctime) == sizeof(int) ? (unsigned long long) (unsigned int) ((shmid_ds).shm_ctime) : sizeof((shmid_ds).shm_ctime) == sizeof(long) ? (unsigned long long) (unsigned long) ((shmid_ds).shm_ctime) : (unsigned long long) ((shmid_ds).shm_ctime))); } while (0);
 }
 tprint_struct_end();
}
static void
        ...
        const unsigned int cmd)
{
 ...
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&info)), (void *) (&info)))
  return;
 tprint_struct_begin();
 do { tprints_field_name("shmmax"); tprintf_string("%llu", (sizeof((info).shmmax) == sizeof(char) ? (unsigned long long) (unsigned char) ((info).shmmax) : sizeof((info).shmmax) == sizeof(short) ? (unsigned long long) (unsigned short) ((info).shmmax) : sizeof((info).shmmax) == sizeof(int) ? (unsigned long long) (unsigned int) ((info).shmmax) : sizeof((info).shmmax) == sizeof(long) ? (unsigned long long) (unsigned long) ((info).shmmax) : (unsigned long long) ((info).shmmax))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("shmmin"); tprintf_string("%llu", (sizeof((info).shmmin) == sizeof(char) ? (unsigned long long) (unsigned char) ((info).shmmin) : sizeof((info).shmmin) == sizeof(short) ? (unsigned long long) (unsigned short) ((info).shmmin) : sizeof((info).shmmin) == sizeof(int) ? (unsigned long long) (unsigned int) ((info).shmmin) : sizeof((info).shmmin) == sizeof(long) ? (unsigned long long) (unsigned long) ((info).shmmin) : (unsigned long long) ((info).shmmin))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("shmmni"); tprintf_string("%llu", (sizeof((info).shmmni) == sizeof(char) ? (unsigned long long) (unsigned char) ((info).shmmni) : sizeof((info).shmmni) == sizeof(short) ? (unsigned long long) (unsigned short) ((info).shmmni) : sizeof((info).shmmni) == sizeof(int) ? (unsigned long long) (unsigned int) ((info).shmmni) : sizeof((info).shmmni) == sizeof(long) ? (unsigned long long) (unsigned long) ((info).shmmni) : (unsigned long long) ((info).shmmni))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("shmseg"); tprintf_string("%llu", (sizeof((info).shmseg) == sizeof(char) ? (unsigned long long) (unsigned char) ((info).shmseg) : sizeof((info).shmseg) == sizeof(short) ? (unsigned long long) (unsigned short) ((info).shmseg) : sizeof((info).shmseg) == sizeof(int) ? (unsigned long long) (unsigned int) ((info).shmseg) : sizeof((info).shmseg) == sizeof(long) ? (unsigned long long) (unsigned long) ((info).shmseg) : (unsigned long long) ((info).shmseg))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("shmall"); tprintf_string("%llu", (sizeof((info).shmall) == sizeof(char) ? (unsigned long long) (unsigned char) ((info).shmall) : sizeof((info).shmall) == sizeof(short) ? (unsigned long long) (unsigned short) ((info).shmall) : sizeof((info).shmall) == sizeof(int) ? (unsigned long long) (unsigned int) ((info).shmall) : sizeof((info).shmall) == sizeof(long) ? (unsigned long long) (unsigned long) ((info).shmall) : (unsigned long long) ((info).shmall))); } while (0);
 tprint_struct_end();
}
static void
        ...
        const unsigned int cmd)
{
 ...
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&info)), (void *) (&info)))
  return;
 tprint_struct_begin();
 do { tprints_field_name("used_ids"); tprintf_string("%lld", (sizeof((info).used_ids) == sizeof(char) ? (long long) (signed char) ((info).used_ids) : sizeof((info).used_ids) == sizeof(short) ? (long long) (short) ((info).used_ids) : sizeof((info).used_ids) == sizeof(int) ? (long long) (int) ((info).used_ids) : sizeof((info).used_ids) == sizeof(long) ? (long long) (long) ((info).used_ids) : (long long) ((info).used_ids))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("shm_tot"); tprintf_string("%llu", (sizeof((info).shm_tot) == sizeof(char) ? (unsigned long long) (unsigned char) ((info).shm_tot) : sizeof((info).shm_tot) == sizeof(short) ? (unsigned long long) (unsigned short) ((info).shm_tot) : sizeof((info).shm_tot) == sizeof(int) ? (unsigned long long) (unsigned int) ((info).shm_tot) : sizeof((info).shm_tot) == sizeof(long) ? (unsigned long long) (unsigned long) ((info).shm_tot) : (unsigned long long) ((info).shm_tot))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("shm_rss"); tprintf_string("%llu", (sizeof((info).shm_rss) == sizeof(char) ? (unsigned long long) (unsigned char) ((info).shm_rss) : sizeof((info).shm_rss) == sizeof(short) ? (unsigned long long) (unsigned short) ((info).shm_rss) : sizeof((info).shm_rss) == sizeof(int) ? (unsigned long long) (unsigned int) ((info).shm_rss) : sizeof((info).shm_rss) == sizeof(long) ? (unsigned long long) (unsigned long) ((info).shm_rss) : (unsigned long long) ((info).shm_rss))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("shm_swp"); tprintf_string("%llu", (sizeof((info).shm_swp) == sizeof(char) ? (unsigned long long) (unsigned char) ((info).shm_swp) : sizeof((info).shm_swp) == sizeof(short) ? (unsigned long long) (unsigned short) ((info).shm_swp) : sizeof((info).shm_swp) == sizeof(int) ? (unsigned long long) (unsigned int) ((info).shm_swp) : sizeof((info).shm_swp) == sizeof(long) ? (unsigned long long) (unsigned long) ((info).shm_swp) : (unsigned long long) ((info).shm_swp))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("swap_attempts"); tprintf_string("%llu", (sizeof((info).swap_attempts) == sizeof(char) ? (unsigned long long) (unsigned char) ((info).swap_attempts) : sizeof((info).swap_attempts) == sizeof(short) ? (unsigned long long) (unsigned short) ((info).swap_attempts) : sizeof((info).swap_attempts) == sizeof(int) ? (unsigned long long) (unsigned int) ((info).swap_attempts) : sizeof((info).swap_attempts) == sizeof(long) ? (unsigned long long) (unsigned long) ((info).swap_attempts) : (unsigned long long) ((info).swap_attempts))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("swap_successes"); tprintf_string("%llu", (sizeof((info).swap_successes) == sizeof(char) ? (unsigned long long) (unsigned char) ((info).swap_successes) : sizeof((info).swap_successes) == sizeof(short) ? (unsigned long long) (unsigned short) ((info).swap_successes) : sizeof((info).swap_successes) == sizeof(int) ? (unsigned long long) (unsigned int) ((info).swap_successes) : sizeof((info).swap_successes) == sizeof(long) ? (unsigned long long) (unsigned long) ((info).swap_successes) : (unsigned long long) ((info).swap_successes))); } while (0);
 tprint_struct_end();
}
int sys_shmctl(struct tcb *tcp)
{
 const kernel_ulong_t addr = tcp->u_arg[((tcp->s_ent ?: &stub_sysent)->sys_flags & 000001000) ? 3 : 2];
 unsigned int cmd = tcp->u_arg[1];
 if (cmd & 0x0100)
  cmd &= ~0x0100;
 if ((!((tcp)->flags & 0x04))) {
  tprints_arg_name("shmid");
  tprintf_string("%lld", (sizeof((int) tcp->u_arg[0]) == sizeof(char) ? (long long) (signed char) ((int) tcp->u_arg[0]) : sizeof((int) tcp->u_arg[0]) == sizeof(short) ? (long long) (short) ((int) tcp->u_arg[0]) : sizeof((int) tcp->u_arg[0]) == sizeof(int) ? (long long) (int) ((int) tcp->u_arg[0]) : sizeof((int) tcp->u_arg[0]) == sizeof(long) ? (long long) (long) ((int) tcp->u_arg[0]) : (long long) ((int) tcp->u_arg[0])));
  tprints_arg_next_name("op");
  do { tprint_flags_begin(); if ((tcp->u_arg[1]) & 0x0100) { print_xlat_ex((0x0100), "IPC_64", XLAT_STYLE_DEFAULT); tprint_flags_or(); } printxval((shmctl_flags), (tcp->u_arg[1]) & ~0x0100, "SHM_???"); tprint_flags_end(); } while (0);
