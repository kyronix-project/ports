...
;
_Static_assert((0x1) == ((1 << 0)), "IFF_UP != (1 << 0)");
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
;
_Static_assert((0x2) == ((1 << 1)), "IFF_BROADCAST != (1 << 1)");

#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (0x2)
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
;
_Static_assert((0x4) == ((1 << 2)), "IFF_DEBUG != (1 << 2)");

#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (0x4)
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
;
_Static_assert((0x8) == ((1 << 3)), "IFF_LOOPBACK != (1 << 3)");

#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (0x8)
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
;
_Static_assert((0x10) == ((1 << 4)), "IFF_POINTOPOINT != (1 << 4)");

#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (0x10)
      > (unsigned long long) ((0x8)),
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
;
_Static_assert((0x20) == ((1 << 5)), "IFF_NOTRAILERS != (1 << 5)");

#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (0x20)
      > (unsigned long long) ((0x10)),
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
;
_Static_assert((0x40) == ((1 << 6)), "IFF_RUNNING != (1 << 6)");

#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (0x40)
      > (unsigned long long) ((0x20)),
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
;
_Static_assert((0x80) == ((1 << 7)), "IFF_NOARP != (1 << 7)");

#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (0x80)
      > (unsigned long long) ((0x40)),
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
;
_Static_assert((0x100) == ((1 << 8)), "IFF_PROMISC != (1 << 8)");

#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (0x100)
      > (unsigned long long) ((0x80)),
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
;
_Static_assert((0x200) == ((1 << 9)), "IFF_ALLMULTI != (1 << 9)");

#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (0x200)
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
;
_Static_assert((0x400) == ((1 << 10)), "IFF_MASTER != (1 << 10)");

#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (0x400)
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
;
_Static_assert((0x800) == ((1 << 11)), "IFF_SLAVE != (1 << 11)");

#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (0x800)
      > (unsigned long long) ((0x400)),
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
;
_Static_assert((0x1000) == ((1 << 12)), "IFF_MULTICAST != (1 << 12)");

#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (0x1000)
      > (unsigned long long) ((0x800)),
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
;
_Static_assert((0x2000) == ((1 << 13)), "IFF_PORTSEL != (1 << 13)");

#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (0x2000)
      > (unsigned long long) ((0x1000)),
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
;
_Static_assert((0x4000) == ((1 << 14)), "IFF_AUTOMEDIA != (1 << 14)");

#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (0x4000)
      > (unsigned long long) ((0x2000)),
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
;
_Static_assert((0x8000) == ((1 << 15)), "IFF_DYNAMIC != (1 << 15)");

#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (0x8000)
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
;
_Static_assert((0x10000) == ((1 << 16)), "IFF_LOWER_UP != (1 << 16)");

#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (0x10000)
      > (unsigned long long) ((0x8000)),
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
;
_Static_assert((0x20000) == ((1 << 17)), "IFF_DORMANT != (1 << 17)");

#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (0x20000)
      > (unsigned long long) ((0x10000)),
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
;
_Static_assert((0x40000) == ((1 << 18)), "IFF_ECHO != (1 << 18)");

#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (0x40000)
      > (unsigned long long) ((0x20000)),
      "Incorrect order in #sorted xlat: IFF_ECHO"
      " is not larger than the previous value");

static const struct xlat_data iffflags_xdata[] = {
 { (unsigned)(0x1), "IFF_UP" },
 { (unsigned)(0x2), "IFF_BROADCAST" },
 { (unsigned)(0x4), "IFF_DEBUG" },
 { (unsigned)(0x8), "IFF_LOOPBACK" },
 { (unsigned)(0x10), "IFF_POINTOPOINT" },
 { (unsigned)(0x20), "IFF_NOTRAILERS" },
 { (unsigned)(0x40), "IFF_RUNNING" },
 { (unsigned)(0x80), "IFF_NOARP" },
 { (unsigned)(0x100), "IFF_PROMISC" },
 { (unsigned)(0x200), "IFF_ALLMULTI" },
 { (unsigned)(0x400), "IFF_MASTER" },
 { (unsigned)(0x800), "IFF_SLAVE" },
 { (unsigned)(0x1000), "IFF_MULTICAST" },
 { (unsigned)(0x2000), "IFF_PORTSEL" },
 { (unsigned)(0x4000), "IFF_AUTOMEDIA" },
 { (unsigned)(0x8000), "IFF_DYNAMIC" },
 { (unsigned)(0x10000), "IFF_LOWER_UP" },
 { (unsigned)(0x20000), "IFF_DORMANT" },
 { (unsigned)(0x40000), "IFF_ECHO" },
};
const struct xlat iffflags[1] = { {
 .data = iffflags_xdata,
 .size = (sizeof(iffflags_xdata) / sizeof((iffflags_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__((iffflags_xdata)), __typeof__(&(iffflags_xdata)[0])))]) * 0)),
 .type = XT_SORTED,
 .flags_mask = 0
  | ((unsigned) (0x1))
  | ((unsigned) (0x2))
...
_Static_assert((unsigned long long) (24)
      ...
      " is not larger than the previous value");
_Static_assert((unsigned long long) (27)
      > (unsigned long long) ((24)),
      "Incorrect order in #sorted xlat: ARPHRD_EUI64"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (32)
      > (unsigned long long) ((27)),
      "Incorrect order in #sorted xlat: ARPHRD_INFINIBAND"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (256)
      > (unsigned long long) ((32)),
      "Incorrect order in #sorted xlat: ARPHRD_SLIP"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (257)
      > (unsigned long long) ((256)),
      "Incorrect order in #sorted xlat: ARPHRD_CSLIP"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (258)
      > (unsigned long long) ((257)),
      "Incorrect order in #sorted xlat: ARPHRD_SLIP6"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (259)
      > (unsigned long long) ((258)),
      "Incorrect order in #sorted xlat: ARPHRD_CSLIP6"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (260)
      > (unsigned long long) ((259)),
      "Incorrect order in #sorted xlat: ARPHRD_RSRVD"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (264)
      > (unsigned long long) ((260)),
      "Incorrect order in #sorted xlat: ARPHRD_ADAPT"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (270)
      > (unsigned long long) ((264)),
      "Incorrect order in #sorted xlat: ARPHRD_ROSE"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (271)
      > (unsigned long long) ((270)),
      "Incorrect order in #sorted xlat: ARPHRD_X25"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (272)
      > (unsigned long long) ((271)),
      "Incorrect order in #sorted xlat: ARPHRD_HWX25"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (280)
      > (unsigned long long) ((272)),
      "Incorrect order in #sorted xlat: ARPHRD_CAN"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (290)
      > (unsigned long long) ((280)),
      "Incorrect order in #sorted xlat: ARPHRD_MCTP"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (512)
      > (unsigned long long) ((290)),
      "Incorrect order in #sorted xlat: ARPHRD_PPP"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (513)
      > (unsigned long long) ((512)),
      "Incorrect order in #sorted xlat: ARPHRD_CISCO"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (516)
      > (unsigned long long) ((513)),
      "Incorrect order in #sorted xlat: ARPHRD_LAPB"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (517)
      > (unsigned long long) ((516)),
      "Incorrect order in #sorted xlat: ARPHRD_DDCMP"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (518)
      > (unsigned long long) ((517)),
      "Incorrect order in #sorted xlat: ARPHRD_RAWHDLC"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (519)
      > (unsigned long long) ((518)),
      "Incorrect order in #sorted xlat: ARPHRD_RAWIP"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (768)
      > (unsigned long long) ((519)),
      "Incorrect order in #sorted xlat: ARPHRD_TUNNEL"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (769)
      > (unsigned long long) ((768)),
      "Incorrect order in #sorted xlat: ARPHRD_TUNNEL6"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (770)
      > (unsigned long long) ((769)),
      "Incorrect order in #sorted xlat: ARPHRD_FRAD"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (771)
      > (unsigned long long) ((770)),
      "Incorrect order in #sorted xlat: ARPHRD_SKIP"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (772)
      > (unsigned long long) ((771)),
      "Incorrect order in #sorted xlat: ARPHRD_LOOPBACK"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (773)
      > (unsigned long long) ((772)),
      "Incorrect order in #sorted xlat: ARPHRD_LOCALTLK"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (774)
      > (unsigned long long) ((773)),
      "Incorrect order in #sorted xlat: ARPHRD_FDDI"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (775)
      > (unsigned long long) ((774)),
      "Incorrect order in #sorted xlat: ARPHRD_BIF"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (776)
      > (unsigned long long) ((775)),
      "Incorrect order in #sorted xlat: ARPHRD_SIT"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (777)
      > (unsigned long long) ((776)),
      "Incorrect order in #sorted xlat: ARPHRD_IPDDP"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (778)
      > (unsigned long long) ((777)),
      "Incorrect order in #sorted xlat: ARPHRD_IPGRE"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (779)
      > (unsigned long long) ((778)),
      "Incorrect order in #sorted xlat: ARPHRD_PIMREG"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (780)
      > (unsigned long long) ((779)),
      "Incorrect order in #sorted xlat: ARPHRD_HIPPI"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (781)
      > (unsigned long long) ((780)),
      "Incorrect order in #sorted xlat: ARPHRD_ASH"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (782)
      > (unsigned long long) ((781)),
      "Incorrect order in #sorted xlat: ARPHRD_ECONET"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (783)
      > (unsigned long long) ((782)),
      "Incorrect order in #sorted xlat: ARPHRD_IRDA"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (784)
      > (unsigned long long) ((783)),
      "Incorrect order in #sorted xlat: ARPHRD_FCPP"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (785)
      > (unsigned long long) ((784)),
      "Incorrect order in #sorted xlat: ARPHRD_FCAL"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (786)
      > (unsigned long long) ((785)),
      "Incorrect order in #sorted xlat: ARPHRD_FCPL"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (787)
      > (unsigned long long) ((786)),
      "Incorrect order in #sorted xlat: ARPHRD_FCFABRIC"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (800)
      > (unsigned long long) ((787)),
      "Incorrect order in #sorted xlat: ARPHRD_IEEE802_TR"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (801)
      > (unsigned long long) ((800)),
      "Incorrect order in #sorted xlat: ARPHRD_IEEE80211"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (802)
      > (unsigned long long) ((801)),
      "Incorrect order in #sorted xlat: ARPHRD_IEEE80211_PRISM"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (803)
      > (unsigned long long) ((802)),
      "Incorrect order in #sorted xlat: ARPHRD_IEEE80211_RADIOTAP"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (804)
      > (unsigned long long) ((803)),
      "Incorrect order in #sorted xlat: ARPHRD_IEEE802154"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (805)
      > (unsigned long long) ((804)),
      "Incorrect order in #sorted xlat: ARPHRD_IEEE802154_MONITOR"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (820)
      > (unsigned long long) ((805)),
      "Incorrect order in #sorted xlat: ARPHRD_PHONET"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (821)
      > (unsigned long long) ((820)),
      "Incorrect order in #sorted xlat: ARPHRD_PHONET_PIPE"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (822)
      > (unsigned long long) ((821)),
      "Incorrect order in #sorted xlat: ARPHRD_CAIF"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (823)
      > (unsigned long long) ((822)),
      "Incorrect order in #sorted xlat: ARPHRD_IP6GRE"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (824)
      > (unsigned long long) ((823)),
      "Incorrect order in #sorted xlat: ARPHRD_NETLINK"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (825)
      > (unsigned long long) ((824)),
      "Incorrect order in #sorted xlat: ARPHRD_6LOWPAN"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (826)
      > (unsigned long long) ((825)),
      "Incorrect order in #sorted xlat: ARPHRD_VSOCKMON"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (0xFFFE)
      > (unsigned long long) ((826)),
      "Incorrect order in #sorted xlat: ARPHRD_NONE"
      " is not larger than the previous value");
_Static_assert((unsigned long long) (0xFFFF)
      > (unsigned long long) ((0xFFFE)),
...
{
 tprint_struct_begin();
 do { tprints_field_name("mem_start"); tprintf_string("%#llx", (sizeof((*p).mem_start) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).mem_start) : sizeof((*p).mem_start) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).mem_start) : sizeof((*p).mem_start) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).mem_start) : sizeof((*p).mem_start) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).mem_start) : (unsigned long long) ((*p).mem_start))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("mem_end"); tprintf_string("%#llx", (sizeof((*p).mem_end) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).mem_end) : sizeof((*p).mem_end) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).mem_end) : sizeof((*p).mem_end) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).mem_end) : sizeof((*p).mem_end) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).mem_end) : (unsigned long long) ((*p).mem_end))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("base_addr"); tprintf_string("%#llx", (sizeof((*p).base_addr) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).base_addr) : sizeof((*p).base_addr) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).base_addr) : sizeof((*p).base_addr) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).base_addr) : sizeof((*p).base_addr) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).base_addr) : (unsigned long long) ((*p).base_addr))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("irq"); tprintf_string("%#llx", (sizeof((*p).irq) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).irq) : sizeof((*p).irq) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).irq) : sizeof((*p).irq) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).irq) : sizeof((*p).irq) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).irq) : (unsigned long long) ((*p).irq))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("dma"); tprintf_string("%#llx", (sizeof((*p).dma) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).dma) : sizeof((*p).dma) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).dma) : sizeof((*p).dma) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).dma) : sizeof((*p).dma) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).dma) : (unsigned long long) ((*p).dma))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("port"); tprintf_string("%#llx", (sizeof((*p).port) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).port) : sizeof((*p).port) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).port) : sizeof((*p).port) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).port) : sizeof((*p).port) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).port) : (unsigned long long) ((*p).port))); } while (0);
 tprint_struct_end();
}
static void
     ...
     const kernel_ulong_t arg, const struct_ifreq *const ifr)
{
 ...
 case 0x8913:
  ...
  break;
 case 0x8933:
  do { tprints_field_name("ifr_ifindex"); tprintf_string("%lld", (sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(char) ? (long long) (signed char) ((*ifr).ifr_ifru.ifru_ivalue) : sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(short) ? (long long) (short) ((*ifr).ifr_ifru.ifru_ivalue) : sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(int) ? (long long) (int) ((*ifr).ifr_ifru.ifru_ivalue) : sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(long) ? (long long) (long) ((*ifr).ifr_ifru.ifru_ivalue) : (long long) ((*ifr).ifr_ifru.ifru_ivalue))); } while (0);
  break;
 case 0x891e:
 case 0x891d:
  do { tprints_field_name("ifr_metric"); tprintf_string("%lld", (sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(char) ? (long long) (signed char) ((*ifr).ifr_ifru.ifru_ivalue) : sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(short) ? (long long) (short) ((*ifr).ifr_ifru.ifru_ivalue) : sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(int) ? (long long) (int) ((*ifr).ifr_ifru.ifru_ivalue) : sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(long) ? (long long) (long) ((*ifr).ifr_ifru.ifru_ivalue) : (long long) ((*ifr).ifr_ifru.ifru_ivalue))); } while (0);
  break;
 case 0x8922:
 case 0x8921:
  do { tprints_field_name("ifr_mtu"); tprintf_string("%lld", (sizeof((*ifr).ifr_ifru.ifru_mtu) == sizeof(char) ? (long long) (signed char) ((*ifr).ifr_ifru.ifru_mtu) : sizeof((*ifr).ifr_ifru.ifru_mtu) == sizeof(short) ? (long long) (short) ((*ifr).ifr_ifru.ifru_mtu) : sizeof((*ifr).ifr_ifru.ifru_mtu) == sizeof(int) ? (long long) (int) ((*ifr).ifr_ifru.ifru_mtu) : sizeof((*ifr).ifr_ifru.ifru_mtu) == sizeof(long) ? (long long) (long) ((*ifr).ifr_ifru.ifru_mtu) : (long long) ((*ifr).ifr_ifru.ifru_mtu))); } while (0);
  break;
 case 0x8930:
 case 0x8929:
  do { tprints_field_name("ifr_slave"); print_quoted_cstring((const char *) (*ifr).ifr_ifru.ifru_slave, sizeof((*ifr).ifr_ifru.ifru_slave) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__(((*ifr).ifr_ifru.ifru_slave)), __typeof__(&((*ifr).ifr_ifru.ifru_slave)[0])))]) * 0)); } while (0);
  break;
 case 0x8923:
  do { tprints_field_name("ifr_newname"); print_quoted_cstring((const char *) (*ifr).ifr_ifru.ifru_newname, sizeof((*ifr).ifr_ifru.ifru_newname) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__(((*ifr).ifr_ifru.ifru_newname)), __typeof__(&((*ifr).ifr_ifru.ifru_newname)[0])))]) * 0)); } while (0);
  break;
 case 0x8910:
  do { tprints_field_name("ifr_name"); print_quoted_cstring((const char *) (*ifr).ifr_ifrn.ifrn_name, sizeof((*ifr).ifr_ifrn.ifrn_name) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__(((*ifr).ifr_ifrn.ifrn_name)), __typeof__(&((*ifr).ifr_ifrn.ifrn_name)[0])))]) * 0)); } while (0);
  break;
 case 0x8943:
 case 0x8942:
  do { tprints_field_name("ifr_qlen"); tprintf_string("%lld", (sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(char) ? (long long) (signed char) ((*ifr).ifr_ifru.ifru_ivalue) : sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(short) ? (long long) (short) ((*ifr).ifr_ifru.ifru_ivalue) : sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(int) ? (long long) (int) ((*ifr).ifr_ifru.ifru_ivalue) : sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(long) ? (long long) (long) ((*ifr).ifr_ifru.ifru_ivalue) : (long long) ((*ifr).ifr_ifru.ifru_ivalue))); } while (0);
  break;
 case 0x8971:
 case 0x8970:
...
{
 tprintf_string("%lld", (sizeof(len) == sizeof(char) ? (long long) (signed char) (len) : sizeof(len) == sizeof(short) ? (long long) (short) (len) : sizeof(len) == sizeof(int) ? (long long) (int) (len) : sizeof(len) == sizeof(long) ? (long long) (long) (len) : (long long) (len)));
 const unsigned int n = (unsigned int) len / sizeof(struct_ifreq);
 if (len > 0 && n * sizeof(struct_ifreq) == (unsigned int) len) {
  tprint_comment_begin();
  tprintf_string("%llu", (sizeof(n) == sizeof(char) ? (unsigned long long) (unsigned char) (n) : sizeof(n) == sizeof(short) ? (unsigned long long) (unsigned short) (n) : sizeof(n) == sizeof(int) ? (unsigned long long) (unsigned int) (n) : sizeof(n) == sizeof(long) ? (unsigned long long) (unsigned long) (n) : (unsigned long long) (n)));
...
MPERS_PRINTER_DECL(int, sock_ioctl, struct tcb *tcp, const unsigned int code, const kernel_ulong_t arg)
{
 ...
 case 0x894C:
 case 0x8906:
 case (((2U) << (((0 +8)+8)+14)) | (((0x89)) << (0 +8)) | (((0x06)) << 0) | ((((sizeof(long long[2])))) << ((0 +8)+8))):
 case 0x8907:
 case (((2U) << (((0 +8)+8)+14)) | (((0x89)) << (0 +8)) | (((0x07)) << 0) | ((((sizeof(long long[2])))) << ((0 +8)+8))):
 case 0x890D:
 case 0x8955:
 case 0x89b0:
 case 0x8941:
