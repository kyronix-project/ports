...
print_ff_envelope(const struct ff_envelope * const arg)
{
 ...
 tprint_struct_begin();
 do { tprints_field_name("attack_length"); tprintf_string("%llu", (sizeof((*p).attack_length) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).attack_length) : sizeof((*p).attack_length) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).attack_length) : sizeof((*p).attack_length) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).attack_length) : sizeof((*p).attack_length) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).attack_length) : (unsigned long long) ((*p).attack_length))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("attack_level"); tprintf_string("%llu", (sizeof((*p).attack_level) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).attack_level) : sizeof((*p).attack_level) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).attack_level) : sizeof((*p).attack_level) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).attack_level) : sizeof((*p).attack_level) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).attack_level) : (unsigned long long) ((*p).attack_level))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("fade_length"); tprintf_string("%llu", (sizeof((*p).fade_length) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).fade_length) : sizeof((*p).fade_length) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).fade_length) : sizeof((*p).fade_length) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).fade_length) : sizeof((*p).fade_length) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).fade_length) : (unsigned long long) ((*p).fade_length))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("fade_level"); tprintf_string("%#llx", (sizeof((*p).fade_level) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).fade_level) : sizeof((*p).fade_level) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).fade_level) : sizeof((*p).fade_level) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).fade_level) : sizeof((*p).fade_level) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).fade_level) : (unsigned long long) ((*p).fade_level))); } while (0);
 tprint_struct_end();
}
static void
...
{
 tprint_struct_begin();
 do { tprints_field_name("button"); tprintf_string("%llu", (sizeof((*p).button) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).button) : sizeof((*p).button) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).button) : sizeof((*p).button) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).button) : sizeof((*p).button) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).button) : (unsigned long long) ((*p).button))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("interval"); tprintf_string("%llu", (sizeof((*p).interval) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).interval) : sizeof((*p).interval) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).interval) : sizeof((*p).interval) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).interval) : sizeof((*p).interval) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).interval) : (unsigned long long) ((*p).interval))); } while (0);
 tprint_struct_end();
}
static void
...
{
 tprint_struct_begin();
 do { tprints_field_name("length"); tprintf_string("%llu", (sizeof((*p).length) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).length) : sizeof((*p).length) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).length) : sizeof((*p).length) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).length) : sizeof((*p).length) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).length) : (unsigned long long) ((*p).length))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("delay"); tprintf_string("%llu", (sizeof((*p).delay) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).delay) : sizeof((*p).delay) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).delay) : sizeof((*p).delay) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).delay) : sizeof((*p).delay) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).delay) : (unsigned long long) ((*p).delay))); } while (0);
 tprint_struct_end();
}
static void
...
{
 tprint_struct_begin();
 do { tprints_field_name("level"); tprintf_string("%lld", (sizeof((*p).level) == sizeof(char) ? (long long) (signed char) ((*p).level) : sizeof((*p).level) == sizeof(short) ? (long long) (short) ((*p).level) : sizeof((*p).level) == sizeof(int) ? (long long) (int) ((*p).level) : sizeof((*p).level) == sizeof(long) ? (long long) (long) ((*p).level) : (long long) ((*p).level))); } while (0);
 tprint_struct_next();
...
{
 tprint_struct_begin();
 do { tprints_field_name("start_level"); tprintf_string("%lld", (sizeof((*p).start_level) == sizeof(char) ? (long long) (signed char) ((*p).start_level) : sizeof((*p).start_level) == sizeof(short) ? (long long) (short) ((*p).start_level) : sizeof((*p).start_level) == sizeof(int) ? (long long) (int) ((*p).start_level) : sizeof((*p).start_level) == sizeof(long) ? (long long) (long) ((*p).start_level) : (long long) ((*p).start_level))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("end_level"); tprintf_string("%lld", (sizeof((*p).end_level) == sizeof(char) ? (long long) (signed char) ((*p).end_level) : sizeof((*p).end_level) == sizeof(short) ? (long long) (short) ((*p).end_level) : sizeof((*p).end_level) == sizeof(int) ? (long long) (int) ((*p).end_level) : sizeof((*p).end_level) == sizeof(long) ? (long long) (long) ((*p).end_level) : (long long) ((*p).end_level))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("envelope"); (print_ff_envelope)(&((*p).envelope)); } while (0);
 tprint_struct_end();
}
...
{
 tprint_struct_begin();
 do { tprints_field_name("waveform"); tprintf_string("%llu", (sizeof((*p).waveform) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).waveform) : sizeof((*p).waveform) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).waveform) : sizeof((*p).waveform) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).waveform) : sizeof((*p).waveform) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).waveform) : (unsigned long long) ((*p).waveform))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("period"); tprintf_string("%llu", (sizeof((*p).period) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).period) : sizeof((*p).period) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).period) : sizeof((*p).period) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).period) : sizeof((*p).period) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).period) : (unsigned long long) ((*p).period))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("magnitude"); tprintf_string("%lld", (sizeof((*p).magnitude) == sizeof(char) ? (long long) (signed char) ((*p).magnitude) : sizeof((*p).magnitude) == sizeof(short) ? (long long) (short) ((*p).magnitude) : sizeof((*p).magnitude) == sizeof(int) ? (long long) (int) ((*p).magnitude) : sizeof((*p).magnitude) == sizeof(long) ? (long long) (long) ((*p).magnitude) : (long long) ((*p).magnitude))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("offset"); tprintf_string("%lld", (sizeof((*p).offset) == sizeof(char) ? (long long) (signed char) ((*p).offset) : sizeof((*p).offset) == sizeof(short) ? (long long) (short) ((*p).offset) : sizeof((*p).offset) == sizeof(int) ? (long long) (int) ((*p).offset) : sizeof((*p).offset) == sizeof(long) ? (long long) (long) ((*p).offset) : (long long) ((*p).offset))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("phase"); tprintf_string("%llu", (sizeof((*p).phase) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).phase) : sizeof((*p).phase) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).phase) : sizeof((*p).phase) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).phase) : sizeof((*p).phase) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).phase) : (unsigned long long) ((*p).phase))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("envelope"); (print_ff_envelope)(&((*p).envelope)); } while (0);
 tprint_struct_next();
 do { tprints_field_name("custom_len"); tprintf_string("%llu", (sizeof((*p).custom_len) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).custom_len) : sizeof((*p).custom_len) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).custom_len) : sizeof((*p).custom_len) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).custom_len) : sizeof((*p).custom_len) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).custom_len) : (unsigned long long) ((*p).custom_len))); } while (0);
 tprint_struct_next();
...
{
 tprint_struct_begin();
 do { tprints_field_name("strong_magnitude"); tprintf_string("%llu", (sizeof((*p).strong_magnitude) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).strong_magnitude) : sizeof((*p).strong_magnitude) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).strong_magnitude) : sizeof((*p).strong_magnitude) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).strong_magnitude) : sizeof((*p).strong_magnitude) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).strong_magnitude) : (unsigned long long) ((*p).strong_magnitude))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("weak_magnitude"); tprintf_string("%llu", (sizeof((*p).weak_magnitude) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).weak_magnitude) : sizeof((*p).weak_magnitude) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).weak_magnitude) : sizeof((*p).weak_magnitude) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).weak_magnitude) : sizeof((*p).weak_magnitude) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).weak_magnitude) : (unsigned long long) ((*p).weak_magnitude))); } while (0);
 tprint_struct_end();
}
static int
ff_effect_ioctl(struct tcb *const tcp, const kernel_ulong_t arg)
{
 ...
 tprint_struct_next();
 do { tprints_field_name("id"); tprintf_string("%lld", (sizeof((ffe).id) == sizeof(char) ? (long long) (signed char) ((ffe).id) : sizeof((ffe).id) == sizeof(short) ? (long long) (short) ((ffe).id) : sizeof((ffe).id) == sizeof(int) ? (long long) (int) ((ffe).id) : sizeof((ffe).id) == sizeof(long) ? (long long) (long) ((ffe).id) : (long long) ((ffe).id))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("direction"); tprintf_string("%llu", (sizeof((ffe).direction) == sizeof(char) ? (unsigned long long) (unsigned char) ((ffe).direction) : sizeof((ffe).direction) == sizeof(short) ? (unsigned long long) (unsigned short) ((ffe).direction) : sizeof((ffe).direction) == sizeof(int) ? (unsigned long long) (unsigned int) ((ffe).direction) : sizeof((ffe).direction) == sizeof(long) ? (unsigned long long) (unsigned long) ((ffe).direction) : (unsigned long long) ((ffe).direction))); } while (0);
 tprint_struct_next();
...
{
 switch (code) {
 case ( ((1U)<<30) | ((('E'))<<8) | ((0x80)) | ((sizeof(struct ff_effect))<<16) ):
