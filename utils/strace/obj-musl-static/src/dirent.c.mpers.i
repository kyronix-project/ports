...
{
 tprint_struct_begin();
 do { tprints_field_name("d_ino"); tprintf_string("%llu", (sizeof((*dent).d_ino) == sizeof(char) ? (unsigned long long) (unsigned char) ((*dent).d_ino) : sizeof((*dent).d_ino) == sizeof(short) ? (unsigned long long) (unsigned short) ((*dent).d_ino) : sizeof((*dent).d_ino) == sizeof(int) ? (unsigned long long) (unsigned int) ((*dent).d_ino) : sizeof((*dent).d_ino) == sizeof(long) ? (unsigned long long) (unsigned long) ((*dent).d_ino) : (unsigned long long) ((*dent).d_ino))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("d_off"); tprintf_string("%llu", (sizeof((*dent).d_off) == sizeof(char) ? (unsigned long long) (unsigned char) ((*dent).d_off) : sizeof((*dent).d_off) == sizeof(short) ? (unsigned long long) (unsigned short) ((*dent).d_off) : sizeof((*dent).d_off) == sizeof(int) ? (unsigned long long) (unsigned int) ((*dent).d_off) : sizeof((*dent).d_off) == sizeof(long) ? (unsigned long long) (unsigned long) ((*dent).d_off) : (unsigned long long) ((*dent).d_off))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("d_reclen"); tprintf_string("%llu", (sizeof((*dent).d_reclen) == sizeof(char) ? (unsigned long long) (unsigned char) ((*dent).d_reclen) : sizeof((*dent).d_reclen) == sizeof(short) ? (unsigned long long) (unsigned short) ((*dent).d_reclen) : sizeof((*dent).d_reclen) == sizeof(int) ? (unsigned long long) (unsigned int) ((*dent).d_reclen) : sizeof((*dent).d_reclen) == sizeof(long) ? (unsigned long long) (unsigned long) ((*dent).d_reclen) : (unsigned long long) ((*dent).d_reclen))); } while (0);
}
static unsigned int
...
print_old_dirent(struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 printpathn(tcp, addr + header_size,
     (((dent.d_reclen) < (256)) ? (dent.d_reclen) : (256)) + 1);
 tprint_struct_end();
}
int sys_readdir(struct tcb *tcp)
{
 if ((!((tcp)->flags & 0x04))) {
  ...
  if (count != 1) {
   ...
   tprintf_string("%llu", (sizeof(count) == sizeof(char) ? (unsigned long long) (unsigned char) (count) : sizeof(count) == sizeof(short) ? (unsigned long long) (unsigned short) (count) : sizeof(count) == sizeof(int) ? (unsigned long long) (unsigned int) (count) : sizeof(count) == sizeof(long) ? (unsigned long long) (unsigned long) (count) : (unsigned long long) (count)));
  }
 }
 return 0;
}
