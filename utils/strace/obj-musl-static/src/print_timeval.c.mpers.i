...
{
 tprint_struct_begin();
 do { tprints_field_name("tv_sec"); tprintf_string("%lld", (sizeof((*t).tv_sec) == sizeof(char) ? (long long) (signed char) ((*t).tv_sec) : sizeof((*t).tv_sec) == sizeof(short) ? (long long) (short) ((*t).tv_sec) : sizeof((*t).tv_sec) == sizeof(int) ? (long long) (int) ((*t).tv_sec) : sizeof((*t).tv_sec) == sizeof(long) ? (long long) (long) ((*t).tv_sec) : (long long) ((*t).tv_sec))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("tv_usec"); tprintf_string("%llu", (sizeof((*t).tv_usec) == sizeof(char) ? (unsigned long long) (unsigned char) ((*t).tv_usec) : sizeof((*t).tv_usec) == sizeof(short) ? (unsigned long long) (unsigned short) ((*t).tv_usec) : sizeof((*t).tv_usec) == sizeof(int) ? (unsigned long long) (unsigned int) ((*t).tv_usec) : sizeof((*t).tv_usec) == sizeof(long) ? (unsigned long long) (unsigned long) ((*t).tv_usec) : (unsigned long long) ((*t).tv_usec))); } while (0);
 tprint_struct_end();
}
static _Bool
...
MPERS_PRINTER_DECL(int, print_timeval_utimes, struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&t)), (void *) (&t)))
  return -1;
 print_local_array_ex((tcp), (t), (sizeof(t) / sizeof((t)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__((t)), __typeof__(&(t)[0])))]) * 0)), sizeof((t)[0]), (print_timeval_t_utime), ((void*)0), 0, ((void*)0), ((void*)0));
 return 0;
}
