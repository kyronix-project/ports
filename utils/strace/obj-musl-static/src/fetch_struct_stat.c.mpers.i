...
MPERS_PRINTER_DECL(_Bool, fetch_struct_stat, struct tcb *const tcp, const kernel_ulong_t addr, struct strace_stat *const dst)
{
 ...
 dst->atime = (sizeof(buf.st_atime) == sizeof(char) ? (long long) (signed char) (buf.st_atime) : sizeof(buf.st_atime) == sizeof(short) ? (long long) (short) (buf.st_atime) : sizeof(buf.st_atime) == sizeof(int) ? (long long) (int) (buf.st_atime) : sizeof(buf.st_atime) == sizeof(long) ? (long long) (long) (buf.st_atime) : (long long) (buf.st_atime));
 dst->ctime = (sizeof(buf.st_ctime) == sizeof(char) ? (long long) (signed char) (buf.st_ctime) : sizeof(buf.st_ctime) == sizeof(short) ? (long long) (short) (buf.st_ctime) : sizeof(buf.st_ctime) == sizeof(int) ? (long long) (int) (buf.st_ctime) : sizeof(buf.st_ctime) == sizeof(long) ? (long long) (long) (buf.st_ctime) : (long long) (buf.st_ctime));
 dst->mtime = (sizeof(buf.st_mtime) == sizeof(char) ? (long long) (signed char) (buf.st_mtime) : sizeof(buf.st_mtime) == sizeof(short) ? (long long) (short) (buf.st_mtime) : sizeof(buf.st_mtime) == sizeof(int) ? (long long) (int) (buf.st_mtime) : sizeof(buf.st_mtime) == sizeof(long) ? (long long) (long) (buf.st_mtime) : (long long) (buf.st_mtime));
