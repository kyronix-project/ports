...
const struct xlat sg_io_info[1] = { {
 ...
 .size = (sizeof(sg_io_info_xdata) / sizeof((sg_io_info_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__((sg_io_info_xdata)), __typeof__(&(sg_io_info_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((unsigned) (0x1))
  | ((unsigned) (0x2))
...
const struct xlat sg_io_dxfer_direction[1] = { {
 ...
 .size = (sizeof(sg_io_dxfer_direction_xdata) / sizeof((sg_io_dxfer_direction_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__((sg_io_dxfer_direction_xdata)), __typeof__(&(sg_io_dxfer_direction_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((unsigned) (-1))
  | ((unsigned) (-2))
...
const struct xlat sg_io_flags[1] = { {
 ...
 .size = (sizeof(sg_io_flags_xdata) / sizeof((sg_io_flags_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__((sg_io_flags_xdata)), __typeof__(&(sg_io_flags_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((unsigned) (1))
  | ((unsigned) (2))
     ...
     const unsigned int data_size, const unsigned int iovec_count)
{
 if (iovec_count) {
  tprint_iov_upto(tcp, iovec_count, addr, data_size,
    iov_decode_str, ((void*)0));
 } else {
  printstr_ex(tcp, addr, data_size, (0x80 | (HEXSTR_ALL << 8)));
 }
}
static int
decode_request(struct tcb *const tcp, const kernel_ulong_t arg)
{
 ...
 tprint_struct_next();
 do { tprints_field_name("cmd_len"); tprintf_string("%llu", (sizeof((sg_io).cmd_len) == sizeof(char) ? (unsigned long long) (unsigned char) ((sg_io).cmd_len) : sizeof((sg_io).cmd_len) == sizeof(short) ? (unsigned long long) (unsigned short) ((sg_io).cmd_len) : sizeof((sg_io).cmd_len) == sizeof(int) ? (unsigned long long) (unsigned int) ((sg_io).cmd_len) : sizeof((sg_io).cmd_len) == sizeof(long) ? (unsigned long long) (unsigned long) ((sg_io).cmd_len) : (unsigned long long) ((sg_io).cmd_len))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("cmdp"); print_sg_io_buffer((tcp), (mpers_ptr_t)((sg_io).cmdp), (sg_io.cmd_len), (0)); } while (0);
 tprint_struct_next();
 do { tprints_field_name("mx_sb_len"); tprintf_string("%llu", (sizeof((sg_io).mx_sb_len) == sizeof(char) ? (unsigned long long) (unsigned char) ((sg_io).mx_sb_len) : sizeof((sg_io).mx_sb_len) == sizeof(short) ? (unsigned long long) (unsigned short) ((sg_io).mx_sb_len) : sizeof((sg_io).mx_sb_len) == sizeof(int) ? (unsigned long long) (unsigned int) ((sg_io).mx_sb_len) : sizeof((sg_io).mx_sb_len) == sizeof(long) ? (unsigned long long) (unsigned long) ((sg_io).mx_sb_len) : (unsigned long long) ((sg_io).mx_sb_len))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("iovec_count"); tprintf_string("%llu", (sizeof((sg_io).iovec_count) == sizeof(char) ? (unsigned long long) (unsigned char) ((sg_io).iovec_count) : sizeof((sg_io).iovec_count) == sizeof(short) ? (unsigned long long) (unsigned short) ((sg_io).iovec_count) : sizeof((sg_io).iovec_count) == sizeof(int) ? (unsigned long long) (unsigned int) ((sg_io).iovec_count) : sizeof((sg_io).iovec_count) == sizeof(long) ? (unsigned long long) (unsigned long) ((sg_io).iovec_count) : (unsigned long long) ((sg_io).iovec_count))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("dxfer_len"); tprintf_string("%llu", (sizeof((sg_io).dxfer_len) == sizeof(char) ? (unsigned long long) (unsigned char) ((sg_io).dxfer_len) : sizeof((sg_io).dxfer_len) == sizeof(short) ? (unsigned long long) (unsigned short) ((sg_io).dxfer_len) : sizeof((sg_io).dxfer_len) == sizeof(int) ? (unsigned long long) (unsigned int) ((sg_io).dxfer_len) : sizeof((sg_io).dxfer_len) == sizeof(long) ? (unsigned long long) (unsigned long) ((sg_io).dxfer_len) : (unsigned long long) ((sg_io).dxfer_len))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("timeout"); tprintf_string("%llu", (sizeof((sg_io).timeout) == sizeof(char) ? (unsigned long long) (unsigned char) ((sg_io).timeout) : sizeof((sg_io).timeout) == sizeof(short) ? (unsigned long long) (unsigned short) ((sg_io).timeout) : sizeof((sg_io).timeout) == sizeof(int) ? (unsigned long long) (unsigned int) ((sg_io).timeout) : sizeof((sg_io).timeout) == sizeof(long) ? (unsigned long long) (unsigned long) ((sg_io).timeout) : (unsigned long long) ((sg_io).timeout))); } while (0);
 tprint_struct_next();
 ...
 struct_sg_io_hdr *entering_sg_io = xmemdup(&sg_io, sizeof(*(&sg_io)));
...
decode_response(struct tcb *const tcp, const kernel_ulong_t arg)
{
 ...
 if (sg_io.interface_id != entering_sg_io->interface_id) {
  ...
  do { tprints_field_name("interface_id"); tprintf_string("%llu", (sizeof((sg_io).interface_id) == sizeof(char) ? (unsigned long long) (unsigned char) ((sg_io).interface_id) : sizeof((sg_io).interface_id) == sizeof(short) ? (unsigned long long) (unsigned short) ((sg_io).interface_id) : sizeof((sg_io).interface_id) == sizeof(int) ? (unsigned long long) (unsigned int) ((sg_io).interface_id) : sizeof((sg_io).interface_id) == sizeof(long) ? (unsigned long long) (unsigned long) ((sg_io).interface_id) : (unsigned long long) ((sg_io).interface_id))); } while (0);
  return 0200;
 }
 ...
 tprint_struct_next();
 do { tprints_field_name("status"); tprintf_string("%#llx", (sizeof((sg_io).status) == sizeof(char) ? (unsigned long long) (unsigned char) ((sg_io).status) : sizeof((sg_io).status) == sizeof(short) ? (unsigned long long) (unsigned short) ((sg_io).status) : sizeof((sg_io).status) == sizeof(int) ? (unsigned long long) (unsigned int) ((sg_io).status) : sizeof((sg_io).status) == sizeof(long) ? (unsigned long long) (unsigned long) ((sg_io).status) : (unsigned long long) ((sg_io).status))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("masked_status"); tprintf_string("%#llx", (sizeof((sg_io).masked_status) == sizeof(char) ? (unsigned long long) (unsigned char) ((sg_io).masked_status) : sizeof((sg_io).masked_status) == sizeof(short) ? (unsigned long long) (unsigned short) ((sg_io).masked_status) : sizeof((sg_io).masked_status) == sizeof(int) ? (unsigned long long) (unsigned int) ((sg_io).masked_status) : sizeof((sg_io).masked_status) == sizeof(long) ? (unsigned long long) (unsigned long) ((sg_io).masked_status) : (unsigned long long) ((sg_io).masked_status))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("msg_status"); tprintf_string("%#llx", (sizeof((sg_io).msg_status) == sizeof(char) ? (unsigned long long) (unsigned char) ((sg_io).msg_status) : sizeof((sg_io).msg_status) == sizeof(short) ? (unsigned long long) (unsigned short) ((sg_io).msg_status) : sizeof((sg_io).msg_status) == sizeof(int) ? (unsigned long long) (unsigned int) ((sg_io).msg_status) : sizeof((sg_io).msg_status) == sizeof(long) ? (unsigned long long) (unsigned long) ((sg_io).msg_status) : (unsigned long long) ((sg_io).msg_status))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("sb_len_wr"); tprintf_string("%llu", (sizeof((sg_io).sb_len_wr) == sizeof(char) ? (unsigned long long) (unsigned char) ((sg_io).sb_len_wr) : sizeof((sg_io).sb_len_wr) == sizeof(short) ? (unsigned long long) (unsigned short) ((sg_io).sb_len_wr) : sizeof((sg_io).sb_len_wr) == sizeof(int) ? (unsigned long long) (unsigned int) ((sg_io).sb_len_wr) : sizeof((sg_io).sb_len_wr) == sizeof(long) ? (unsigned long long) (unsigned long) ((sg_io).sb_len_wr) : (unsigned long long) ((sg_io).sb_len_wr))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("sbp"); print_sg_io_buffer((tcp), (mpers_ptr_t)((sg_io).sbp), (sg_io.sb_len_wr), (0)); } while (0);
 tprint_struct_next();
 do { tprints_field_name("host_status"); tprintf_string("%#llx", (sizeof((sg_io).host_status) == sizeof(char) ? (unsigned long long) (unsigned char) ((sg_io).host_status) : sizeof((sg_io).host_status) == sizeof(short) ? (unsigned long long) (unsigned short) ((sg_io).host_status) : sizeof((sg_io).host_status) == sizeof(int) ? (unsigned long long) (unsigned int) ((sg_io).host_status) : sizeof((sg_io).host_status) == sizeof(long) ? (unsigned long long) (unsigned long) ((sg_io).host_status) : (unsigned long long) ((sg_io).host_status))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("driver_status"); tprintf_string("%#llx", (sizeof((sg_io).driver_status) == sizeof(char) ? (unsigned long long) (unsigned char) ((sg_io).driver_status) : sizeof((sg_io).driver_status) == sizeof(short) ? (unsigned long long) (unsigned short) ((sg_io).driver_status) : sizeof((sg_io).driver_status) == sizeof(int) ? (unsigned long long) (unsigned int) ((sg_io).driver_status) : sizeof((sg_io).driver_status) == sizeof(long) ? (unsigned long long) (unsigned long) ((sg_io).driver_status) : (unsigned long long) ((sg_io).driver_status))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("resid"); tprintf_string("%lld", (sizeof((sg_io).resid) == sizeof(char) ? (long long) (signed char) ((sg_io).resid) : sizeof((sg_io).resid) == sizeof(short) ? (long long) (short) ((sg_io).resid) : sizeof((sg_io).resid) == sizeof(int) ? (long long) (int) ((sg_io).resid) : sizeof((sg_io).resid) == sizeof(long) ? (long long) (long) ((sg_io).resid) : (long long) ((sg_io).resid))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("duration"); tprintf_string("%llu", (sizeof((sg_io).duration) == sizeof(char) ? (unsigned long long) (unsigned char) ((sg_io).duration) : sizeof((sg_io).duration) == sizeof(short) ? (unsigned long long) (unsigned short) ((sg_io).duration) : sizeof((sg_io).duration) == sizeof(int) ? (unsigned long long) (unsigned int) ((sg_io).duration) : sizeof((sg_io).duration) == sizeof(long) ? (unsigned long long) (unsigned long) ((sg_io).duration) : (unsigned long long) ((sg_io).duration))); } while (0);
 tprint_struct_next();
