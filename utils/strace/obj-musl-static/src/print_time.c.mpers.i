...
int sys_time(struct tcb *tcp)
{
 if (((tcp)->flags & 0x04)) {
  ...
  if (!umoven_or_printaddr((tcp), (tcp->u_arg[0]), sizeof(*(&t)), (void *) (&t))) {
   ...
   tprintf_string("%lld", (sizeof(t) == sizeof(char) ? (long long) (signed char) (t) : sizeof(t) == sizeof(short) ? (long long) (short) (t) : sizeof(t) == sizeof(int) ? (long long) (int) (t) : sizeof(t) == sizeof(long) ? (long long) (long) (t) : (long long) (t)));
