...
#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (16)
...
const struct xlat semctl_flags[1] = { {
 ...
 .size = (sizeof(semctl_flags_xdata) / sizeof((semctl_flags_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__((semctl_flags_xdata)), __typeof__(&(semctl_flags_xdata)[0])))]) * 0)),
 .type = XT_SORTED,
 .flags_mask = 0
  | ((unsigned) (0))
  | ((unsigned) (1))
        ...
        const unsigned int cmd, const _Bool indirect_addr)
{
 ...
 if (cmd != 1) {
  tprint_struct_next();
  do { tprints_field_name("sem_otime"); tprintf_string("%llu", (sizeof((ds).sem_otime) == sizeof(char) ? (unsigned long long) (unsigned char) ((ds).sem_otime) : sizeof((ds).sem_otime) == sizeof(short) ? (unsigned long long) (unsigned short) ((ds).sem_otime) : sizeof((ds).sem_otime) == sizeof(int) ? (unsigned long long) (unsigned int) ((ds).sem_otime) : sizeof((ds).sem_otime) == sizeof(long) ? (unsigned long long) (unsigned long) ((ds).sem_otime) : (unsigned long long) ((ds).sem_otime))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("sem_ctime"); tprintf_string("%llu", (sizeof((ds).sem_ctime) == sizeof(char) ? (unsigned long long) (unsigned char) ((ds).sem_ctime) : sizeof((ds).sem_ctime) == sizeof(short) ? (unsigned long long) (unsigned short) ((ds).sem_ctime) : sizeof((ds).sem_ctime) == sizeof(int) ? (unsigned long long) (unsigned int) ((ds).sem_ctime) : sizeof((ds).sem_ctime) == sizeof(long) ? (unsigned long long) (unsigned long) ((ds).sem_ctime) : (unsigned long long) ((ds).sem_ctime))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("sem_nsems"); tprintf_string("%llu", (sizeof((ds).sem_nsems) == sizeof(char) ? (unsigned long long) (unsigned char) ((ds).sem_nsems) : sizeof((ds).sem_nsems) == sizeof(short) ? (unsigned long long) (unsigned short) ((ds).sem_nsems) : sizeof((ds).sem_nsems) == sizeof(int) ? (unsigned long long) (unsigned int) ((ds).sem_nsems) : sizeof((ds).sem_nsems) == sizeof(long) ? (unsigned long long) (unsigned long) ((ds).sem_nsems) : (unsigned long long) ((ds).sem_nsems))); } while (0);
 }
 tprint_struct_end();
}
static void
       ...
       const unsigned int cmd, const _Bool indirect_addr)
{
 ...
 tprint_struct_begin();
 do { tprints_field_name("semmap"); tprintf_string("%lld", (sizeof((info).semmap) == sizeof(char) ? (long long) (signed char) ((info).semmap) : sizeof((info).semmap) == sizeof(short) ? (long long) (short) ((info).semmap) : sizeof((info).semmap) == sizeof(int) ? (long long) (int) ((info).semmap) : sizeof((info).semmap) == sizeof(long) ? (long long) (long) ((info).semmap) : (long long) ((info).semmap))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("semmni"); tprintf_string("%lld", (sizeof((info).semmni) == sizeof(char) ? (long long) (signed char) ((info).semmni) : sizeof((info).semmni) == sizeof(short) ? (long long) (short) ((info).semmni) : sizeof((info).semmni) == sizeof(int) ? (long long) (int) ((info).semmni) : sizeof((info).semmni) == sizeof(long) ? (long long) (long) ((info).semmni) : (long long) ((info).semmni))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("semmns"); tprintf_string("%lld", (sizeof((info).semmns) == sizeof(char) ? (long long) (signed char) ((info).semmns) : sizeof((info).semmns) == sizeof(short) ? (long long) (short) ((info).semmns) : sizeof((info).semmns) == sizeof(int) ? (long long) (int) ((info).semmns) : sizeof((info).semmns) == sizeof(long) ? (long long) (long) ((info).semmns) : (long long) ((info).semmns))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("semmnu"); tprintf_string("%lld", (sizeof((info).semmnu) == sizeof(char) ? (long long) (signed char) ((info).semmnu) : sizeof((info).semmnu) == sizeof(short) ? (long long) (short) ((info).semmnu) : sizeof((info).semmnu) == sizeof(int) ? (long long) (int) ((info).semmnu) : sizeof((info).semmnu) == sizeof(long) ? (long long) (long) ((info).semmnu) : (long long) ((info).semmnu))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("semmsl"); tprintf_string("%lld", (sizeof((info).semmsl) == sizeof(char) ? (long long) (signed char) ((info).semmsl) : sizeof((info).semmsl) == sizeof(short) ? (long long) (short) ((info).semmsl) : sizeof((info).semmsl) == sizeof(int) ? (long long) (int) ((info).semmsl) : sizeof((info).semmsl) == sizeof(long) ? (long long) (long) ((info).semmsl) : (long long) ((info).semmsl))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("semopm"); tprintf_string("%lld", (sizeof((info).semopm) == sizeof(char) ? (long long) (signed char) ((info).semopm) : sizeof((info).semopm) == sizeof(short) ? (long long) (short) ((info).semopm) : sizeof((info).semopm) == sizeof(int) ? (long long) (int) ((info).semopm) : sizeof((info).semopm) == sizeof(long) ? (long long) (long) ((info).semopm) : (long long) ((info).semopm))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("semume"); tprintf_string("%lld", (sizeof((info).semume) == sizeof(char) ? (long long) (signed char) ((info).semume) : sizeof((info).semume) == sizeof(short) ? (long long) (short) ((info).semume) : sizeof((info).semume) == sizeof(int) ? (long long) (int) ((info).semume) : sizeof((info).semume) == sizeof(long) ? (long long) (long) ((info).semume) : (long long) ((info).semume))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("semusz"); tprintf_string("%lld", (sizeof((info).semusz) == sizeof(char) ? (long long) (signed char) ((info).semusz) : sizeof((info).semusz) == sizeof(short) ? (long long) (short) ((info).semusz) : sizeof((info).semusz) == sizeof(int) ? (long long) (int) ((info).semusz) : sizeof((info).semusz) == sizeof(long) ? (long long) (long) ((info).semusz) : (long long) ((info).semusz))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("semvmx"); tprintf_string("%lld", (sizeof((info).semvmx) == sizeof(char) ? (long long) (signed char) ((info).semvmx) : sizeof((info).semvmx) == sizeof(short) ? (long long) (short) ((info).semvmx) : sizeof((info).semvmx) == sizeof(int) ? (long long) (int) ((info).semvmx) : sizeof((info).semvmx) == sizeof(long) ? (long long) (long) ((info).semvmx) : (long long) ((info).semvmx))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("semaem"); tprintf_string("%lld", (sizeof((info).semaem) == sizeof(char) ? (long long) (signed char) ((info).semaem) : sizeof((info).semaem) == sizeof(short) ? (long long) (short) ((info).semaem) : sizeof((info).semaem) == sizeof(int) ? (long long) (int) ((info).semaem) : sizeof((info).semaem) == sizeof(long) ? (long long) (long) ((info).semaem) : (long long) ((info).semaem))); } while (0);
 tprint_struct_end();
}
int sys_semctl(struct tcb *tcp)
{
 ...
 const _Bool indirect_addr = ((tcp->s_ent ?: &stub_sysent)->sys_flags & 000001000)
      ;
 if (cmd & 0x0100)
  cmd &= ~0x0100;
 if ((!((tcp)->flags & 0x04))) {
  ...
  tprintf_string("%lld", (sizeof((int) tcp->u_arg[1]) == sizeof(char) ? (long long) (signed char) ((int) tcp->u_arg[1]) : sizeof((int) tcp->u_arg[1]) == sizeof(short) ? (long long) (short) ((int) tcp->u_arg[1]) : sizeof((int) tcp->u_arg[1]) == sizeof(int) ? (long long) (int) ((int) tcp->u_arg[1]) : sizeof((int) tcp->u_arg[1]) == sizeof(long) ? (long long) (long) ((int) tcp->u_arg[1]) : (long long) ((int) tcp->u_arg[1])));
  tprints_arg_next_name("op");
  do { tprint_flags_begin(); if ((tcp->u_arg[2]) & 0x0100) { print_xlat_ex((0x0100), "IPC_64", XLAT_STYLE_DEFAULT); tprint_flags_or(); } printxval((semctl_flags), (tcp->u_arg[2]) & ~0x0100, "SEM_???"); tprint_flags_end(); } while (0);
