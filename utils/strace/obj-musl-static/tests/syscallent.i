...
[0 + 436] = { 3, 0, SEN(close_range), "close_range" },
...
[0 + 443] = { 4, TD, SEN(quotactl_fd), "quotactl_fd" },
[0 + 444] = { 3, TD, SEN(landlock_create_ruleset), "landlock_create_ruleset" },
[0 + 445] = { 4, TD, SEN(landlock_add_rule), "landlock_add_rule" },
[0 + 446] = { 2, TD, SEN(landlock_restrict_self), "landlock_restrict_self" },
[0 + 447] = { 1, TD, SEN(memfd_secret), "memfd_secret" },
[0 + 448] = { 2, TD, SEN(process_mrelease), "process_mrelease" },
[0 + 449] = { 5, 0, SEN(futex_waitv), "futex_waitv" },
[0 + 450] = { 4, TM, SEN(set_mempolicy_home_node), "set_mempolicy_home_node" },
[0 + 451] = { 4, TD, SEN(cachestat), "cachestat" },
[0 + 452] = { 4, TD|TF, SEN(fchmodat2), "fchmodat2" },
[0 + 453] = { 3, TM, SEN(map_shadow_stack), "map_shadow_stack" },
[0 + 454] = { 4, 0, SEN(futex_wake), "futex_wake" },
[0 + 455] = { 6, 0, SEN(futex_wait), "futex_wait" },
[0 + 456] = { 4, 0, SEN(futex_requeue), "futex_requeue" },
[0 + 457] = { 4, 0, SEN(statmount), "statmount" },
[0 + 458] = { 4, 0, SEN(listmount), "listmount" },
[0 + 459] = { 4, 0, SEN(lsm_get_self_attr), "lsm_get_self_attr" },
[0 + 460] = { 4, 0, SEN(lsm_set_self_attr), "lsm_set_self_attr" },
[0 + 461] = { 3, 0, SEN(lsm_list_modules), "lsm_list_modules" },
[0 + 462] = { 3, TM, SEN(mseal), "mseal" },
[0 + 463] = { 6, TD|TF, SEN(setxattrat), "setxattrat" },
[0 + 464] = { 6, TD|TF, SEN(getxattrat), "getxattrat" },
[0 + 465] = { 5, TD|TF, SEN(listxattrat), "listxattrat" },
[0 + 466] = { 4, TD|TF, SEN(removexattrat), "removexattrat" },
[0 + 467] = { 5, TD|TF, SEN(open_tree_attr), "open_tree_attr"},
[0 + 468] = { 5, TD|TF, SEN(file_getattr), "file_getattr" },
[0 + 469] = { 5, TD|TF, SEN(file_setattr), "file_setattr" },
[0 + 470] = { 4, 0, SEN(listns), "listns" },
[0 + 471] = { 0, 0, SEN(rseq_slice_yield), "rseq_slice_yield" },
