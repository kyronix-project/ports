...
# ifdef HAVE_UNION_BPF_ATTR_VALUE_TYPE_BTF_OBJ_FD
	static_assert(sizeof_field(struct BPF_MAP_CREATE_struct, value_type_btf_obj_fd) == sizeof_field(union bpf_attr, value_type_btf_obj_fd),
		      "BPF_MAP_CREATE_struct.value_type_btf_obj_fd size mismatch");
	static_assert(offsetof(struct BPF_MAP_CREATE_struct, value_type_btf_obj_fd) == offsetof(union bpf_attr, value_type_btf_obj_fd),
		      "BPF_MAP_CREATE_struct.value_type_btf_obj_fd offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_VALUE_TYPE_BTF_OBJ_FD */

# ifdef HAVE_UNION_BPF_ATTR_MAP_TOKEN_FD
	static_assert(sizeof_field(struct BPF_MAP_CREATE_struct, map_token_fd) == sizeof_field(union bpf_attr, map_token_fd),
		      "BPF_MAP_CREATE_struct.map_token_fd size mismatch");
	static_assert(offsetof(struct BPF_MAP_CREATE_struct, map_token_fd) == offsetof(union bpf_attr, map_token_fd),
		      "BPF_MAP_CREATE_struct.map_token_fd offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_MAP_TOKEN_FD */

# ifdef HAVE_UNION_BPF_ATTR_EXCL_PROG_HASH
	static_assert(sizeof_field(struct BPF_MAP_CREATE_struct, excl_prog_hash) == sizeof_field(union bpf_attr, excl_prog_hash),
		      "BPF_MAP_CREATE_struct.excl_prog_hash size mismatch");
	static_assert(offsetof(struct BPF_MAP_CREATE_struct, excl_prog_hash) == offsetof(union bpf_attr, excl_prog_hash),
		      "BPF_MAP_CREATE_struct.excl_prog_hash offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_EXCL_PROG_HASH */

# ifdef HAVE_UNION_BPF_ATTR_EXCL_PROG_HASH_SIZE
	static_assert(sizeof_field(struct BPF_MAP_CREATE_struct, excl_prog_hash_size) == sizeof_field(union bpf_attr, excl_prog_hash_size),
		      "BPF_MAP_CREATE_struct.excl_prog_hash_size size mismatch");
	static_assert(offsetof(struct BPF_MAP_CREATE_struct, excl_prog_hash_size) == offsetof(union bpf_attr, excl_prog_hash_size),
		      "BPF_MAP_CREATE_struct.excl_prog_hash_size offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_EXCL_PROG_HASH_SIZE */
...
# ifdef HAVE_UNION_BPF_ATTR_CORE_RELO_CNT
	static_assert(sizeof_field(struct BPF_PROG_LOAD_struct, core_relo_cnt) == sizeof_field(union bpf_attr, core_relo_cnt),
		      "BPF_PROG_LOAD_struct.core_relo_cnt size mismatch");
	static_assert(offsetof(struct BPF_PROG_LOAD_struct, core_relo_cnt) == offsetof(union bpf_attr, core_relo_cnt),
		      "BPF_PROG_LOAD_struct.core_relo_cnt offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_CORE_RELO_CNT */
...
# ifdef HAVE_UNION_BPF_ATTR_CORE_RELOS
	static_assert(sizeof_field(struct BPF_PROG_LOAD_struct, core_relos) == sizeof_field(union bpf_attr, core_relos),
		      "BPF_PROG_LOAD_struct.core_relos size mismatch");
	static_assert(offsetof(struct BPF_PROG_LOAD_struct, core_relos) == offsetof(union bpf_attr, core_relos),
		      "BPF_PROG_LOAD_struct.core_relos offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_CORE_RELOS */

# ifdef HAVE_UNION_BPF_ATTR_CORE_RELO_REC_SIZE
	static_assert(sizeof_field(struct BPF_PROG_LOAD_struct, core_relo_rec_size) == sizeof_field(union bpf_attr, core_relo_rec_size),
		      "BPF_PROG_LOAD_struct.core_relo_rec_size size mismatch");
	static_assert(offsetof(struct BPF_PROG_LOAD_struct, core_relo_rec_size) == offsetof(union bpf_attr, core_relo_rec_size),
		      "BPF_PROG_LOAD_struct.core_relo_rec_size offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_CORE_RELO_REC_SIZE */

# ifdef HAVE_UNION_BPF_ATTR_LOG_TRUE_SIZE
	static_assert(sizeof_field(struct BPF_PROG_LOAD_struct, log_true_size) == sizeof_field(union bpf_attr, log_true_size),
		      "BPF_PROG_LOAD_struct.log_true_size size mismatch");
	static_assert(offsetof(struct BPF_PROG_LOAD_struct, log_true_size) == offsetof(union bpf_attr, log_true_size),
		      "BPF_PROG_LOAD_struct.log_true_size offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_LOG_TRUE_SIZE */

# ifdef HAVE_UNION_BPF_ATTR_PROG_TOKEN_FD
	static_assert(sizeof_field(struct BPF_PROG_LOAD_struct, prog_token_fd) == sizeof_field(union bpf_attr, prog_token_fd),
		      "BPF_PROG_LOAD_struct.prog_token_fd size mismatch");
	static_assert(offsetof(struct BPF_PROG_LOAD_struct, prog_token_fd) == offsetof(union bpf_attr, prog_token_fd),
		      "BPF_PROG_LOAD_struct.prog_token_fd offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_PROG_TOKEN_FD */

# ifdef HAVE_UNION_BPF_ATTR_FD_ARRAY_CNT
	static_assert(sizeof_field(struct BPF_PROG_LOAD_struct, fd_array_cnt) == sizeof_field(union bpf_attr, fd_array_cnt),
		      "BPF_PROG_LOAD_struct.fd_array_cnt size mismatch");
	static_assert(offsetof(struct BPF_PROG_LOAD_struct, fd_array_cnt) == offsetof(union bpf_attr, fd_array_cnt),
		      "BPF_PROG_LOAD_struct.fd_array_cnt offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_FD_ARRAY_CNT */

# ifdef HAVE_UNION_BPF_ATTR_SIGNATURE
	static_assert(sizeof_field(struct BPF_PROG_LOAD_struct, signature) == sizeof_field(union bpf_attr, signature),
		      "BPF_PROG_LOAD_struct.signature size mismatch");
	static_assert(offsetof(struct BPF_PROG_LOAD_struct, signature) == offsetof(union bpf_attr, signature),
		      "BPF_PROG_LOAD_struct.signature offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_SIGNATURE */

# ifdef HAVE_UNION_BPF_ATTR_SIGNATURE_SIZE
	static_assert(sizeof_field(struct BPF_PROG_LOAD_struct, signature_size) == sizeof_field(union bpf_attr, signature_size),
		      "BPF_PROG_LOAD_struct.signature_size size mismatch");
	static_assert(offsetof(struct BPF_PROG_LOAD_struct, signature_size) == offsetof(union bpf_attr, signature_size),
		      "BPF_PROG_LOAD_struct.signature_size offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_SIGNATURE_SIZE */

# ifdef HAVE_UNION_BPF_ATTR_KEYRING_ID
	static_assert(sizeof_field(struct BPF_PROG_LOAD_struct, keyring_id) == sizeof_field(union bpf_attr, keyring_id),
		      "BPF_PROG_LOAD_struct.keyring_id size mismatch");
	static_assert(offsetof(struct BPF_PROG_LOAD_struct, keyring_id) == offsetof(union bpf_attr, keyring_id),
		      "BPF_PROG_LOAD_struct.keyring_id offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_KEYRING_ID */
...
# ifdef HAVE_UNION_BPF_ATTR_TARGET_IFINDEX
	static_assert(sizeof_field(struct BPF_PROG_ATTACH_struct, target_ifindex) == sizeof_field(union bpf_attr, target_ifindex),
		      "BPF_PROG_ATTACH_struct.target_ifindex size mismatch");
	static_assert(offsetof(struct BPF_PROG_ATTACH_struct, target_ifindex) == offsetof(union bpf_attr, target_ifindex),
		      "BPF_PROG_ATTACH_struct.target_ifindex offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_TARGET_IFINDEX */
...
# ifdef HAVE_UNION_BPF_ATTR_RELATIVE_FD
	static_assert(sizeof_field(struct BPF_PROG_ATTACH_struct, relative_fd) == sizeof_field(union bpf_attr, relative_fd),
		      "BPF_PROG_ATTACH_struct.relative_fd size mismatch");
	static_assert(offsetof(struct BPF_PROG_ATTACH_struct, relative_fd) == offsetof(union bpf_attr, relative_fd),
		      "BPF_PROG_ATTACH_struct.relative_fd offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_RELATIVE_FD */

# ifdef HAVE_UNION_BPF_ATTR_RELATIVE_ID
	static_assert(sizeof_field(struct BPF_PROG_ATTACH_struct, relative_id) == sizeof_field(union bpf_attr, relative_id),
		      "BPF_PROG_ATTACH_struct.relative_id size mismatch");
	static_assert(offsetof(struct BPF_PROG_ATTACH_struct, relative_id) == offsetof(union bpf_attr, relative_id),
		      "BPF_PROG_ATTACH_struct.relative_id offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_RELATIVE_ID */

# ifdef HAVE_UNION_BPF_ATTR_EXPECTED_REVISION
	static_assert(sizeof_field(struct BPF_PROG_ATTACH_struct, expected_revision) == sizeof_field(union bpf_attr, expected_revision),
		      "BPF_PROG_ATTACH_struct.expected_revision size mismatch");
	static_assert(offsetof(struct BPF_PROG_ATTACH_struct, expected_revision) == offsetof(union bpf_attr, expected_revision),
		      "BPF_PROG_ATTACH_struct.expected_revision offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_EXPECTED_REVISION */
...
# ifdef HAVE_UNION_BPF_ATTR_QUERY_TARGET_IFINDEX
	static_assert(sizeof_field(struct BPF_PROG_QUERY_struct, target_ifindex) == sizeof_field(union bpf_attr, query.target_ifindex),
		      "BPF_PROG_QUERY_struct.target_ifindex size mismatch");
	static_assert(offsetof(struct BPF_PROG_QUERY_struct, target_ifindex) == offsetof(union bpf_attr, query.target_ifindex),
		      "BPF_PROG_QUERY_struct.target_ifindex offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_QUERY_TARGET_IFINDEX */
...
# ifdef HAVE_UNION_BPF_ATTR_QUERY_DUMMY
	static_assert(sizeof_field(struct BPF_PROG_QUERY_struct, dummy) == sizeof_field(union bpf_attr, query.dummy),
		      "BPF_PROG_QUERY_struct.dummy size mismatch");
	static_assert(offsetof(struct BPF_PROG_QUERY_struct, dummy) == offsetof(union bpf_attr, query.dummy),
		      "BPF_PROG_QUERY_struct.dummy offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_QUERY_DUMMY */

# ifdef HAVE_UNION_BPF_ATTR_QUERY_PROG_ATTACH_FLAGS
	static_assert(sizeof_field(struct BPF_PROG_QUERY_struct, prog_attach_flags) == sizeof_field(union bpf_attr, query.prog_attach_flags),
		      "BPF_PROG_QUERY_struct.prog_attach_flags size mismatch");
	static_assert(offsetof(struct BPF_PROG_QUERY_struct, prog_attach_flags) == offsetof(union bpf_attr, query.prog_attach_flags),
		      "BPF_PROG_QUERY_struct.prog_attach_flags offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_QUERY_PROG_ATTACH_FLAGS */

# ifdef HAVE_UNION_BPF_ATTR_QUERY_LINK_IDS
	static_assert(sizeof_field(struct BPF_PROG_QUERY_struct, link_ids) == sizeof_field(union bpf_attr, query.link_ids),
		      "BPF_PROG_QUERY_struct.link_ids size mismatch");
	static_assert(offsetof(struct BPF_PROG_QUERY_struct, link_ids) == offsetof(union bpf_attr, query.link_ids),
		      "BPF_PROG_QUERY_struct.link_ids offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_QUERY_LINK_IDS */

# ifdef HAVE_UNION_BPF_ATTR_QUERY_LINK_ATTACH_FLAGS
	static_assert(sizeof_field(struct BPF_PROG_QUERY_struct, link_attach_flags) == sizeof_field(union bpf_attr, query.link_attach_flags),
		      "BPF_PROG_QUERY_struct.link_attach_flags size mismatch");
	static_assert(offsetof(struct BPF_PROG_QUERY_struct, link_attach_flags) == offsetof(union bpf_attr, query.link_attach_flags),
		      "BPF_PROG_QUERY_struct.link_attach_flags offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_QUERY_LINK_ATTACH_FLAGS */

# ifdef HAVE_UNION_BPF_ATTR_QUERY_REVISION
	static_assert(sizeof_field(struct BPF_PROG_QUERY_struct, revision) == sizeof_field(union bpf_attr, query.revision),
		      "BPF_PROG_QUERY_struct.revision size mismatch");
	static_assert(offsetof(struct BPF_PROG_QUERY_struct, revision) == offsetof(union bpf_attr, query.revision),
		      "BPF_PROG_QUERY_struct.revision offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_QUERY_REVISION */
...
# ifdef HAVE_UNION_BPF_ATTR_BTF_LOG_TRUE_SIZE
	static_assert(sizeof_field(struct BPF_BTF_LOAD_struct, btf_log_true_size) == sizeof_field(union bpf_attr, btf_log_true_size),
		      "BPF_BTF_LOAD_struct.btf_log_true_size size mismatch");
	static_assert(offsetof(struct BPF_BTF_LOAD_struct, btf_log_true_size) == offsetof(union bpf_attr, btf_log_true_size),
		      "BPF_BTF_LOAD_struct.btf_log_true_size offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_BTF_LOG_TRUE_SIZE */

# ifdef HAVE_UNION_BPF_ATTR_BTF_FLAGS
	static_assert(sizeof_field(struct BPF_BTF_LOAD_struct, btf_flags) == sizeof_field(union bpf_attr, btf_flags),
		      "BPF_BTF_LOAD_struct.btf_flags size mismatch");
	static_assert(offsetof(struct BPF_BTF_LOAD_struct, btf_flags) == offsetof(union bpf_attr, btf_flags),
		      "BPF_BTF_LOAD_struct.btf_flags offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_BTF_FLAGS */

# ifdef HAVE_UNION_BPF_ATTR_BTF_TOKEN_FD
	static_assert(sizeof_field(struct BPF_BTF_LOAD_struct, btf_token_fd) == sizeof_field(union bpf_attr, btf_token_fd),
		      "BPF_BTF_LOAD_struct.btf_token_fd size mismatch");
	static_assert(offsetof(struct BPF_BTF_LOAD_struct, btf_token_fd) == offsetof(union bpf_attr, btf_token_fd),
		      "BPF_BTF_LOAD_struct.btf_token_fd offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_BTF_TOKEN_FD */
...
# ifdef HAVE_UNION_BPF_ATTR_NEXT_ID
	static_assert(sizeof_field(struct BPF_BTF_GET_FD_BY_ID_struct, next_id) == sizeof_field(union bpf_attr, next_id),
		      "BPF_BTF_GET_FD_BY_ID_struct.next_id size mismatch");
	static_assert(offsetof(struct BPF_BTF_GET_FD_BY_ID_struct, next_id) == offsetof(union bpf_attr, next_id),
		      "BPF_BTF_GET_FD_BY_ID_struct.next_id offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_NEXT_ID */

# ifdef HAVE_UNION_BPF_ATTR_OPEN_FLAGS
	static_assert(sizeof_field(struct BPF_BTF_GET_FD_BY_ID_struct, open_flags) == sizeof_field(union bpf_attr, open_flags),
		      "BPF_BTF_GET_FD_BY_ID_struct.open_flags size mismatch");
	static_assert(offsetof(struct BPF_BTF_GET_FD_BY_ID_struct, open_flags) == offsetof(union bpf_attr, open_flags),
		      "BPF_BTF_GET_FD_BY_ID_struct.open_flags offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_OPEN_FLAGS */

# ifdef HAVE_UNION_BPF_ATTR_FD_BY_ID_TOKEN_FD
	static_assert(sizeof_field(struct BPF_BTF_GET_FD_BY_ID_struct, fd_by_id_token_fd) == sizeof_field(union bpf_attr, fd_by_id_token_fd),
		      "BPF_BTF_GET_FD_BY_ID_struct.fd_by_id_token_fd size mismatch");
	static_assert(offsetof(struct BPF_BTF_GET_FD_BY_ID_struct, fd_by_id_token_fd) == offsetof(union bpf_attr, fd_by_id_token_fd),
		      "BPF_BTF_GET_FD_BY_ID_struct.fd_by_id_token_fd offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_FD_BY_ID_TOKEN_FD */
...
# ifdef HAVE_STRUCT_BPF_MAP_INFO_BTF_VMLINUX_ID
	static_assert(sizeof_field(struct bpf_map_info_struct, btf_vmlinux_id) == sizeof_field(struct bpf_map_info, btf_vmlinux_id),
		      "bpf_map_info_struct.btf_vmlinux_id size mismatch");
	static_assert(offsetof(struct bpf_map_info_struct, btf_vmlinux_id) == offsetof(struct bpf_map_info, btf_vmlinux_id),
		      "bpf_map_info_struct.btf_vmlinux_id offset mismatch");
# endif /* HAVE_STRUCT_BPF_MAP_INFO_BTF_VMLINUX_ID */
...
# ifdef HAVE_STRUCT_BPF_MAP_INFO_HASH
	static_assert(sizeof_field(struct bpf_map_info_struct, hash) == sizeof_field(struct bpf_map_info, hash),
		      "bpf_map_info_struct.hash size mismatch");
	static_assert(offsetof(struct bpf_map_info_struct, hash) == offsetof(struct bpf_map_info, hash),
		      "bpf_map_info_struct.hash offset mismatch");
# endif /* HAVE_STRUCT_BPF_MAP_INFO_HASH */

# ifdef HAVE_STRUCT_BPF_MAP_INFO_HASH_SIZE
	static_assert(sizeof_field(struct bpf_map_info_struct, hash_size) == sizeof_field(struct bpf_map_info, hash_size),
		      "bpf_map_info_struct.hash_size size mismatch");
	static_assert(offsetof(struct bpf_map_info_struct, hash_size) == offsetof(struct bpf_map_info, hash_size),
		      "bpf_map_info_struct.hash_size offset mismatch");
# endif /* HAVE_STRUCT_BPF_MAP_INFO_HASH_SIZE */
...
# ifdef HAVE_STRUCT_BPF_PROG_INFO_ATTACH_BTF_OBJ_ID
	static_assert(sizeof_field(struct bpf_prog_info_struct, attach_btf_obj_id) == sizeof_field(struct bpf_prog_info, attach_btf_obj_id),
		      "bpf_prog_info_struct.attach_btf_obj_id size mismatch");
	static_assert(offsetof(struct bpf_prog_info_struct, attach_btf_obj_id) == offsetof(struct bpf_prog_info, attach_btf_obj_id),
		      "bpf_prog_info_struct.attach_btf_obj_id offset mismatch");
# endif /* HAVE_STRUCT_BPF_PROG_INFO_ATTACH_BTF_OBJ_ID */

# ifdef HAVE_STRUCT_BPF_PROG_INFO_ATTACH_BTF_ID
	static_assert(sizeof_field(struct bpf_prog_info_struct, attach_btf_id) == sizeof_field(struct bpf_prog_info, attach_btf_id),
		      "bpf_prog_info_struct.attach_btf_id size mismatch");
	static_assert(offsetof(struct bpf_prog_info_struct, attach_btf_id) == offsetof(struct bpf_prog_info, attach_btf_id),
		      "bpf_prog_info_struct.attach_btf_id offset mismatch");
# endif /* HAVE_STRUCT_BPF_PROG_INFO_ATTACH_BTF_ID */
...
# ifdef HAVE_UNION_BPF_ATTR_LINK_CREATE_TARGET_IFINDEX
	static_assert(sizeof_field(struct BPF_LINK_CREATE_struct, target_ifindex) == sizeof_field(union bpf_attr, link_create.target_ifindex),
		      "BPF_LINK_CREATE_struct.target_ifindex size mismatch");
	static_assert(offsetof(struct BPF_LINK_CREATE_struct, target_ifindex) == offsetof(union bpf_attr, link_create.target_ifindex),
		      "BPF_LINK_CREATE_struct.target_ifindex offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_LINK_CREATE_TARGET_IFINDEX */
...
# ifdef HAVE_UNION_BPF_ATTR_LINK_CREATE_PF
	static_assert(sizeof_field(struct BPF_LINK_CREATE_struct, pf) == sizeof_field(union bpf_attr, link_create.pf),
		      "BPF_LINK_CREATE_struct.pf size mismatch");
	static_assert(offsetof(struct BPF_LINK_CREATE_struct, pf) == offsetof(union bpf_attr, link_create.pf),
		      "BPF_LINK_CREATE_struct.pf offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_LINK_CREATE_PF */

# ifdef HAVE_UNION_BPF_ATTR_LINK_CREATE_HOOKNUM
	static_assert(sizeof_field(struct BPF_LINK_CREATE_struct, hooknum) == sizeof_field(union bpf_attr, link_create.hooknum),
		      "BPF_LINK_CREATE_struct.hooknum size mismatch");
	static_assert(offsetof(struct BPF_LINK_CREATE_struct, hooknum) == offsetof(union bpf_attr, link_create.hooknum),
		      "BPF_LINK_CREATE_struct.hooknum offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_LINK_CREATE_HOOKNUM */

# ifdef HAVE_UNION_BPF_ATTR_LINK_CREATE_PRIORITY
	static_assert(sizeof_field(struct BPF_LINK_CREATE_struct, priority) == sizeof_field(union bpf_attr, link_create.priority),
		      "BPF_LINK_CREATE_struct.priority size mismatch");
	static_assert(offsetof(struct BPF_LINK_CREATE_struct, priority) == offsetof(union bpf_attr, link_create.priority),
		      "BPF_LINK_CREATE_struct.priority offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_LINK_CREATE_PRIORITY */
...
# ifdef HAVE_UNION_BPF_ATTR_LINK_CREATE_NETFILTER
	static_assert(sizeof_field(struct BPF_LINK_CREATE_struct, netfilter) == sizeof_field(union bpf_attr, link_create.netfilter),
		      "BPF_LINK_CREATE_struct.netfilter size mismatch");
	static_assert(offsetof(struct BPF_LINK_CREATE_struct, netfilter) == offsetof(union bpf_attr, link_create.netfilter),
		      "BPF_LINK_CREATE_struct.netfilter offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_LINK_CREATE_NETFILTER */

# ifdef HAVE_UNION_BPF_ATTR_LINK_CREATE_RELATIVE_FD
	static_assert(sizeof_field(struct BPF_LINK_CREATE_struct, relative_fd) == sizeof_field(union bpf_attr, link_create.relative_fd),
		      "BPF_LINK_CREATE_struct.relative_fd size mismatch");
	static_assert(offsetof(struct BPF_LINK_CREATE_struct, relative_fd) == offsetof(union bpf_attr, link_create.relative_fd),
		      "BPF_LINK_CREATE_struct.relative_fd offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_LINK_CREATE_RELATIVE_FD */

# ifdef HAVE_UNION_BPF_ATTR_LINK_CREATE_RELATIVE_ID
	static_assert(sizeof_field(struct BPF_LINK_CREATE_struct, relative_id) == sizeof_field(union bpf_attr, link_create.relative_id),
		      "BPF_LINK_CREATE_struct.relative_id size mismatch");
	static_assert(offsetof(struct BPF_LINK_CREATE_struct, relative_id) == offsetof(union bpf_attr, link_create.relative_id),
		      "BPF_LINK_CREATE_struct.relative_id offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_LINK_CREATE_RELATIVE_ID */

# ifdef HAVE_UNION_BPF_ATTR_LINK_CREATE_PATH
	static_assert(sizeof_field(struct BPF_LINK_CREATE_struct, path) == sizeof_field(union bpf_attr, link_create.path),
		      "BPF_LINK_CREATE_struct.path size mismatch");
	static_assert(offsetof(struct BPF_LINK_CREATE_struct, path) == offsetof(union bpf_attr, link_create.path),
		      "BPF_LINK_CREATE_struct.path offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_LINK_CREATE_PATH */

# ifdef HAVE_UNION_BPF_ATTR_LINK_CREATE_OFFSETS
	static_assert(sizeof_field(struct BPF_LINK_CREATE_struct, offsets) == sizeof_field(union bpf_attr, link_create.offsets),
		      "BPF_LINK_CREATE_struct.offsets size mismatch");
	static_assert(offsetof(struct BPF_LINK_CREATE_struct, offsets) == offsetof(union bpf_attr, link_create.offsets),
		      "BPF_LINK_CREATE_struct.offsets offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_LINK_CREATE_OFFSETS */

# ifdef HAVE_UNION_BPF_ATTR_LINK_CREATE_REF_CTR_OFFSETS
	static_assert(sizeof_field(struct BPF_LINK_CREATE_struct, ref_ctr_offsets) == sizeof_field(union bpf_attr, link_create.ref_ctr_offsets),
		      "BPF_LINK_CREATE_struct.ref_ctr_offsets size mismatch");
	static_assert(offsetof(struct BPF_LINK_CREATE_struct, ref_ctr_offsets) == offsetof(union bpf_attr, link_create.ref_ctr_offsets),
		      "BPF_LINK_CREATE_struct.ref_ctr_offsets offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_LINK_CREATE_REF_CTR_OFFSETS */
...
# ifdef HAVE_UNION_BPF_ATTR_LINK_CREATE_PID
	static_assert(sizeof_field(struct BPF_LINK_CREATE_struct, pid) == sizeof_field(union bpf_attr, link_create.pid),
		      "BPF_LINK_CREATE_struct.pid size mismatch");
	static_assert(offsetof(struct BPF_LINK_CREATE_struct, pid) == offsetof(union bpf_attr, link_create.pid),
		      "BPF_LINK_CREATE_struct.pid offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_LINK_CREATE_PID */

# ifdef HAVE_UNION_BPF_ATTR_LINK_CREATE_UPROBE_MULTI
	static_assert(sizeof_field(struct BPF_LINK_CREATE_struct, uprobe_multi) == sizeof_field(union bpf_attr, link_create.uprobe_multi),
		      "BPF_LINK_CREATE_struct.uprobe_multi size mismatch");
	static_assert(offsetof(struct BPF_LINK_CREATE_struct, uprobe_multi) == offsetof(union bpf_attr, link_create.uprobe_multi),
		      "BPF_LINK_CREATE_struct.uprobe_multi offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_LINK_CREATE_UPROBE_MULTI */
...
# ifdef HAVE_UNION_BPF_ATTR_LINK_CREATE_EXPECTED_REVISION
	static_assert(sizeof_field(struct BPF_LINK_CREATE_struct, expected_revision) == sizeof_field(union bpf_attr, link_create.expected_revision),
		      "BPF_LINK_CREATE_struct.expected_revision size mismatch");
	static_assert(offsetof(struct BPF_LINK_CREATE_struct, expected_revision) == offsetof(union bpf_attr, link_create.expected_revision),
		      "BPF_LINK_CREATE_struct.expected_revision offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_LINK_CREATE_EXPECTED_REVISION */
...
# ifdef HAVE_UNION_BPF_ATTR_PROG_STREAM_READ_STREAM_BUF
	static_assert(sizeof_field(struct BPF_PROG_STREAM_READ_BY_FD_struct, stream_buf) == sizeof_field(union bpf_attr, prog_stream_read.stream_buf),
		      "BPF_PROG_STREAM_READ_BY_FD_struct.stream_buf size mismatch");
	static_assert(offsetof(struct BPF_PROG_STREAM_READ_BY_FD_struct, stream_buf) == offsetof(union bpf_attr, prog_stream_read.stream_buf),
		      "BPF_PROG_STREAM_READ_BY_FD_struct.stream_buf offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_PROG_STREAM_READ_STREAM_BUF */

# ifdef HAVE_UNION_BPF_ATTR_PROG_STREAM_READ_STREAM_BUF_LEN
	static_assert(sizeof_field(struct BPF_PROG_STREAM_READ_BY_FD_struct, stream_buf_len) == sizeof_field(union bpf_attr, prog_stream_read.stream_buf_len),
		      "BPF_PROG_STREAM_READ_BY_FD_struct.stream_buf_len size mismatch");
	static_assert(offsetof(struct BPF_PROG_STREAM_READ_BY_FD_struct, stream_buf_len) == offsetof(union bpf_attr, prog_stream_read.stream_buf_len),
		      "BPF_PROG_STREAM_READ_BY_FD_struct.stream_buf_len offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_PROG_STREAM_READ_STREAM_BUF_LEN */

# ifdef HAVE_UNION_BPF_ATTR_PROG_STREAM_READ_STREAM_ID
	static_assert(sizeof_field(struct BPF_PROG_STREAM_READ_BY_FD_struct, stream_id) == sizeof_field(union bpf_attr, prog_stream_read.stream_id),
		      "BPF_PROG_STREAM_READ_BY_FD_struct.stream_id size mismatch");
	static_assert(offsetof(struct BPF_PROG_STREAM_READ_BY_FD_struct, stream_id) == offsetof(union bpf_attr, prog_stream_read.stream_id),
		      "BPF_PROG_STREAM_READ_BY_FD_struct.stream_id offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_PROG_STREAM_READ_STREAM_ID */

# ifdef HAVE_UNION_BPF_ATTR_PROG_STREAM_READ_PROG_FD
	static_assert(sizeof_field(struct BPF_PROG_STREAM_READ_BY_FD_struct, prog_fd) == sizeof_field(union bpf_attr, prog_stream_read.prog_fd),
		      "BPF_PROG_STREAM_READ_BY_FD_struct.prog_fd size mismatch");
	static_assert(offsetof(struct BPF_PROG_STREAM_READ_BY_FD_struct, prog_fd) == offsetof(union bpf_attr, prog_stream_read.prog_fd),
		      "BPF_PROG_STREAM_READ_BY_FD_struct.prog_fd offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_PROG_STREAM_READ_PROG_FD */

static_assert(BPF_PROG_STREAM_READ_BY_FD_struct_size == expected_BPF_PROG_STREAM_READ_BY_FD_struct_size,
	      "BPF_PROG_STREAM_READ_BY_FD_struct_size mismatch");

# ifdef HAVE_UNION_BPF_ATTR_PROG_ASSOC_STRUCT_OPS
	static_assert(sizeof_field(struct BPF_PROG_ASSOC_STRUCT_OPS_struct, prog_assoc_struct_ops) == sizeof_field(union bpf_attr, prog_assoc_struct_ops),
		      "BPF_PROG_ASSOC_STRUCT_OPS_struct.prog_assoc_struct_ops size mismatch");
	static_assert(offsetof(struct BPF_PROG_ASSOC_STRUCT_OPS_struct, prog_assoc_struct_ops) == offsetof(union bpf_attr, prog_assoc_struct_ops),
		      "BPF_PROG_ASSOC_STRUCT_OPS_struct.prog_assoc_struct_ops offset mismatch");
# endif /* HAVE_UNION_BPF_ATTR_PROG_ASSOC_STRUCT_OPS */

static_assert(BPF_PROG_ASSOC_STRUCT_OPS_struct_size == expected_BPF_PROG_ASSOC_STRUCT_OPS_struct_size,
	      "BPF_PROG_ASSOC_STRUCT_OPS_struct_size mismatch");
