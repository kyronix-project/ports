...
XS_EUPXS(XS_Storable_init_perinterp)
{
    ...
    if (items != 0)
       croak_xs_usage(cv,  "");
    {
#line 7758 "Storable.xs"
    init_perinterp(aTHX);
#line 7903 "Storable.c"
    }
    XSRETURN_EMPTY;
}
...
#line 7810 "Storable.xs"
    RETVAL = pretrieve(aTHX_ f, flag);
#line 7980 "Storable.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
...
#line 7819 "Storable.xs"
    RETVAL = mretrieve(aTHX_ sv, flag);
#line 8008 "Storable.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
...
;
	SV *	RETVAL;
#line 7827 "Storable.xs"
    RETVAL = dclone(aTHX_ sv);
#line 8028 "Storable.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
...
XS_EUPXS(XS_Storable_last_op_in_netorder)
{
    ...
    if (items != 0)
       croak_xs_usage(cv,  "");
    {
#line 7837 "Storable.xs"
    bool result;
#line 8046 "Storable.c"
#line 7839 "Storable.xs"
    if (ix) {
        dSTCXT;
        assert(cxt);
