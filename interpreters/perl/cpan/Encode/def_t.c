/*
 ...
 /home/ildar/kyronix-ports/interpreters/perl/miniperl bin/enc2xs -Q -O -o def_t.c -f def_t.fnm
 enc2xs VERSION 2.25
*/
...
#ifdef __cplusplus
extern encpage_t utf8_cp1252[8];
#else
static const encpage_t utf8_cp1252[8];
#endif
#ifdef __cplusplus
extern encpage_t utf8_iso_8859_1[4];
#else
