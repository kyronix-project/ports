...
case "$perladmin" in
'') perladmin='ildar@anmitali-arch.nonet' ;;
esac
...
case "$siteprefix" in
'') if test "/usr/local/perl-musl" = "/usr/local/perl-musl"; then
	siteprefix="$prefix"
    else
	siteprefix='/usr/local/perl-musl'
    fi
    ;;
esac
case "$vendorprefix" in
'') if test "" = "/usr/local/perl-musl"; then
	vendorprefix="$prefix"
    else
	vendorprefix=''
    fi
...
'') if test "/usr/local/perl-musl" = "/usr/local/perl-musl"; then
	...
	installprefix='/usr/local/perl-musl'
    fi
    ;;
esac
...
#     /usr/local/perl-musl, so it isn't included here either.
#
...
# bin='/usr/local/perl-musl/bin'
# scriptdir='/usr/local/perl-musl/bin'
# privlib='/usr/local/perl-musl/lib/5.42.2'
# archlib='/usr/local/perl-musl/lib/5.42.2/x86_64-linux'
# man1dir='/usr/local/perl-musl/man/man1'
# man3dir='/usr/local/perl-musl/man/man3'
# man1ext='1'
# man3ext='3'
...
html3dir=' '
# sitebin='/usr/local/perl-musl/bin'
# sitescript='/usr/local/perl-musl/bin'
# sitelib='/usr/local/perl-musl/lib/site_perl/5.42.2'
# sitearch='/usr/local/perl-musl/lib/site_perl/5.42.2/x86_64-linux'
# siteman1dir='/usr/local/perl-musl/man/man1'
# siteman3dir='/usr/local/perl-musl/man/man3'
# sitehtml1dir=''
# sitehtml3dir=''
# vendorbin=''
# vendorscript=''
