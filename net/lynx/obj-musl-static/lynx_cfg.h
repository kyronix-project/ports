...
#define BROTLI_PATH "/usr/bin/brotli"		/* CF_PATH_PROG(brotli) */
...
#define HAVE_SLEEP 1
#define HAVE_SSL_CLEAR_OPTIONS 1	/* CF_SSL */
...
#define LYNX_CFG_FILE "/etc/lynx.cfg"		/* $sysconfdir/lynx.cfg */
#define LYNX_CFG_PATH "/etc"		/* $sysconfdir */
#define LYNX_LSS_FILE "/etc/lynx.lss"		/* $sysconfdir/lynx.lss */
...
#define SYSTEM_NAME "linux-musl"		/* CF_CHECK_CACHE */
...
#define ZSTD_PATH "/usr/bin/zstd"		/* CF_PATH_PROG(zstd) */
...
#define ut_xstatus ut_exit.__e_exit		/* CF_UTMP_UT_XSTATUS */
