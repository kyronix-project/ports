...
static const struct {
	...
	{ "build_alias",	"x86_64-pc-linux-musl" },
	{ "c11_noreturn",	"no," },
	{ "c_compiler_gnu",	"yes" },
	{ "c_inline",	"inline" },
	{ "chtype_decl",	"yes" },
	{ "chtype_type",	"scalar" },
	{ "color_curses",	"yes" },
	{ "curses_dir",	"/home/ildar/kyronix-ports/libs/ncurses/obj-musl-static" },
	{ "dcl_errno",	"yes" },
	{ "define_sigwinch",	"yes" },
	{ "env_CC_set",	"set" },
	{ "env_CC_value",	"'musl-gcc -fno-link-libatomic -idirafter /home/ildar/kyronix-ports/net/lynx/kernel-headers'" },
	{ "env_CFLAGS_set",	"" },
	{ "env_CFLAGS_value",	"" },
	{ "env_CPPFLAGS_set",	"" },
	{ "env_CPPFLAGS_value",	"" },
	...
	{ "env_CPP_value",	"" },
	{ "env_LDFLAGS_set",	"set" },
	{ "env_LDFLAGS_value",	"-static" },
	{ "env_build_alias_set",	"" },
	{ "env_build_alias_value",	"" },
	{ "env_host_alias_set",	"set" },
	{ "env_host_alias_value",	"x86_64-linux-musl" },
	...
	{ "find_linkage_idn2",	"no" },
	{ "find_linkage_idn",	"no" },
	{ "find_linkage_z",	"maybe" },
	{ "find_linkage_zstd",	"maybe" },
	{ "fionbio",	"ioctl" },
	{ "func_SSL_clear_options",	"yes" },
	...
	{ "have_utmp_ut_name",	"ut_user" },
	{ "have_utmp_ut_session",	"yes" },
	{ "have_utmp_ut_syslen",	"no" },
	{ "have_utmp_ut_xstatus",	"ut_exit.__e_exit" },
	...
	{ "header_limits_h",	"yes" },
	{ "header_memory_h",	"yes" },
	{ "header_ncurses_term_h",	"no" },
	{ "header_path_brotlidec",	"/home/ildar/kyronix-ports/libs/ncurses/obj-musl-static/include" },
	{ "header_path_bz2",	"/home/ildar/kyronix-ports/libs/ncurses/obj-musl-static/include" },
	{ "header_path_iconv",	"/usr/include" },
	{ "header_path_idn2",	"/home/ildar/kyronix-ports/libs/ncurses/obj-musl-static/include" },
	{ "header_path_idn",	"/home/ildar/kyronix-ports/libs/ncurses/obj-musl-static/include" },
	{ "header_path_ssl",	"/home/ildar/kyronix-ports/libs/openssl/stage/usr/include/openssl" },
	{ "header_path_z",	"/usr/include" },
	{ "header_path_zstd",	"/usr/include" },
	{ "header_paths_h",	"yes" },
	{ "header_pwd_h",	"yes" },
	{ "header_sgtty_h",	"no" },
	{ "header_stdc",	"yes" },
	...
	{ "lib_dir_opendir",	"no" },
	{ "lib_gpm_Gpm_Open",	"no" },
	{ "lib_inet_inet_ntoa",	"no" },
	{ "library_path_brotlidec",	"" },
	{ "library_path_bz2",	"" },
	{ "library_path_iconv",	"/usr/lib" },
	{ "library_path_idn2",	"" },
	{ "library_path_idn",	"" },
	{ "library_path_ssl",	"/home/ildar/kyronix-ports/libs/openssl/stage/usr/lib64" },
	{ "library_path_z",	"/usr/local/lib" },
	{ "library_path_zstd",	"/usr/local/lib" },
	{ "locale",	"yes" },
	{ "make_PHONY",	"yes" },
	{ "mixedcase",	"yes" },
	{ "ncurses_broken",	"no" },
	...
	{ "pkg_ssl",	"openssl" },
	{ "posix_visible",	"no" },
	{ "prog_CC",	"'musl-gcc -fno-link-libatomic -idirafter /home/ildar/kyronix-ports/net/lynx/kernel-headers'" },
	{ "prog_CPP",	"'musl-gcc -idirafter /home/ildar/kyronix-ports/net/lynx/kernel-headers -E'" },
	{ "prog_CTAGS",	"ctags" },
	{ "prog_ETAGS",	"etags" },
	{ "prog_GREP",	"grep" },
	...
	{ "type_socklen_t",	"yes" },
	{ "type_ssize_t",	"yes" },
	{ "type_struct_sockaddr",	"yes" },
	{ "type_struct_sockaddr_in",	"yes" },
	{ "type_time_t",	"yes" },
	{ "type_uid_t",	"yes" },
	{ "type_unionwait",	"no" },
