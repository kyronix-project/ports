...
BEGIN {
    ...
    require '/home/ildar/kyronix-ports/libs/openssl/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/ildar/kyronix-ports/libs/openssl/test/fips-and-base.cnf';
    shift;
...
if ($ARGV[0] eq '-jitter') {
    $std_openssl_conf = '/home/ildar/kyronix-ports/libs/openssl/test/default-and-jitter.cnf';
    shift;
